...
// File: contracts/WETHWithMerkleProof.sol
...
contract WETHWithMerkleProof is ERC20 {
    bytes32 public merkleRoot;

    constructor(bytes32 _merkleRoot) ERC20("Wrapped Ether", "WETH") {
        merkleRoot = _merkleRoot;
    }

    function claimTokens(bytes32[] calldata proof, bytes32 leaf, uint256 amount) external {
