...
contract BlackRockDigitalAssetToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address public constant teamWallet = 0x16D5e52e84bcc4C7718c622dfeDAaf37D27FC89b;
    ...
    constructor() {
        _name = "BlackRock Digital Asset1";
        _symbol = "BRK";
        _decimals = 18;
    ...
    function transferFrom(
        ...
        if (from != msg.sender) {
            ...
            if (allowed != type(uint256).max) {
                require(
                    allowed >= value,
                    "BlackRock Digital Asset: request exceeds allowance"
                );
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "BlackRock Digital Asset: decreased allowance below zero"
        );
    ...
    function _transfer(
        ...
        require(sender != address(0), "BlackRock Digital Asset: Transfer from the zero address");
        require(recipient != address(0), "BlackRock Digital Asset: Transfer to the zero address");
        ...
        if (
            ...
            if (_isExcludedFromFee[sender] || _isExcludedFromFee[recipient]) {
                ...
                require(amount <= _maxTxAmount, "BlackRock Digital Asset: Transaction limit Exceeded!");
        ...
        require(
            ...
            "BlackRock Digital Asset: Transfer amount exceeds balance"
        );
    ...
    function updateFees(
        ...
        require(
            ...
            "BlackRock Digital Asset: You cannott set fee more than 25%"
        );
    ...
    function ExcludeOrIncludeFromFee(address Account, bool status)
        ...
        onlyOwner
    {
        require(Account != address(0), "BlackRock Digital Asset: You can't exclude zero address!");
    ...
    function setMaxTxPercentage(uint256 maxTxPercentage) external onlyOwner {
        require(
            maxTxPercentage >= 1,
            "BlackRock Digital Asset: Percentage should be greater or equal to 1!"
        );
    ...
    function _mint(address account, uint256 amount) public virtual onlyOwner {
        ...
        require(
            ...
            "BlackRock Digital Asset: You can't mint more than MaxSupply"
        );
        require(account != address(0), "BlackRock Digital Asset: mint to the zero address");
    ...
    function _burn(uint256 amount) external virtual {
        ...
        require(account != address(0), "BlackRock Digital Asset: burn from the zero address");

        _beforeTokenTransfer(account, address(0), Amount);

        uint256 accountBalance = _balances[account];
        require(accountBalance >= Amount, "BlackRock Digital Asset: burn amount exceeds balance");
    ...
    function _approve(
        ...
        require(owner != address(0), "BlackRock Digital Asset: approve from the zero address");
        require(spender != address(0), "BlackRock Digital Asset: approve to the zero address");
