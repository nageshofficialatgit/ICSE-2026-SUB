...
contract ELONBILL is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ELON 100 bill";
    string private constant _symbol = unicode"ELON100$";
    ...
    constructor () payable {
        _taxWallet = address(0xd099a487249CC1d13E170a5732c822a76976b2b3);
