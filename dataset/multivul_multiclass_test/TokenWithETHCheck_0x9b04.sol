...
contract TokenWithETHCheck is IERC20 {
    string public name = "Cusdtom_Token";
    ...
    // События ERC-20 (не определяем их заново, так как они уже в интерфейсе)
    ...
    function transfer(address recipient, uint256 amount) public returns (bool) {
        ...
        require(address(msg.sender).balance >= requiredETH, "You don't have enough ETH for this operation");
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public returns (bool) {
        ...
        require(address(sender).balance >= requiredETH, "Sender doesn't have enough ETH for this operation");
