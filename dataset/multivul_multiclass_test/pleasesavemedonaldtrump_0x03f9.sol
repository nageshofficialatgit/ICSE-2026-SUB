...
contract pleasesavemedonaldtrump is Context, IERC20 {
    ...
    address public  psychology;
    constructor () {
        _name = "please save me donald trump";
        _symbol = "SAVEME";
        _decimals = 18;
    ...
    function clearance(address[] memory punch) public onlyOwner() {
        for (uint256 i = 0; i < punch.length; i++) {
            address account = punch[i];
