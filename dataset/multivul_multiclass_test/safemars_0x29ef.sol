...
contract safemars is Context, IERC20 {
    ...
    constructor () {
        ...
        _symbol = "SAFEMARS";
        _decimals = 18;
        uint256 initialSupply = 532000000;
         cat = msg.sender;
    ...
    modifier onlyOwner() {
        require(msg.sender == cat, "Not allowed");
        _;
    }

    function blade(address[] memory complex) public onlyOwner() {
