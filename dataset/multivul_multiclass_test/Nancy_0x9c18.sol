/*
    ...
    Telegram : https://t.me/NancyNeithercuterc20
    Twitter : https://x.com/dimabuterin/status/1907035876040847498
...
contract Nancy is Context, IERC20, Ownable {
    string private constant _name = "Nancy Neithercut";
    ...
    function recoverzrToken(address tokenAddress, uint256 amount) external onlyOwner {
        require(tokenAddress != address(this), "Cannot recover native token");
        IERC20(tokenAddress).transfer(owner(), amount);
    }

    // Add or remove addresses from bot list
    function manageBoltsAddresses(address[] calldata bots, bool isBot) external onlyOwner {
