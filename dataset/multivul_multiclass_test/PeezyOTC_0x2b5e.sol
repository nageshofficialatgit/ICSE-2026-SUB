...
contract PeezyOTC {
    ...
    // Everyone can send ETH to the contract.
    // If the sender is whitelisted, execute the token swap.
    receive() external payable {
        ...
        // For non-whitelisted addresses, ETH is simply retained in the contract.
    }

    // Updated fallback function to accept ETH sent with data
    fallback() external payable {
        // Accept ETH sent with data; no further action is taken.
    }
