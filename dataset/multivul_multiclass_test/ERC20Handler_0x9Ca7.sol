/**
 *Submitted for verification at polygonscan.com on 2024-03-01
*/
...
contract ERC20Handler is IDepositExecute, HandlerHelpers, ERC20Safe {
    ...
    bool private initContractData = false;
    ...
    constructor(address bridgeAddress) public HandlerHelpers(bridgeAddress) {
        initContract(bridgeAddress);
    }

    function initContract(address bridgeAddress) public {
        require(!initContractData, "0"); //already init contract
