...
DeSync ($DSC) redefines cloud storage with encrypted, decentralized data ownership.

With secure, token-powered access, users can store, retrieve, and manage files privately free from third-party control. 
No tracking. No censorship. Just true privacy.

Learn more: Whitepaper https://docs.desync.live

Website: https://www.desync.live
App: https://app.desync.live
Twitter/X: https://x.com/desync_io
Docs: https://docs.desync.live
Link tree: https://linktr.ee/Desync1
...
contract DESYNC is ERC20, Ownable {
    ...
    string private constant _name = unicode"DESYNC";
