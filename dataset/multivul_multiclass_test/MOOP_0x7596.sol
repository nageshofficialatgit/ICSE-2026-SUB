...
// File: contracts/moop_V3.sol

/*
 ****************************************************************************************
*****************************************************************************************
MMMMMMMM***************MMMMMMMM*****OOOOOOOOO**********OOOOOOOOO*****PPPPPPPPPPPPPPPPP***
M:::::::M*************M:::::::M***OO:::::::::OO******OO:::::::::OO***P::::::::::::::::P**
M::::::::M***********M::::::::M*OO:::::::::::::OO**OO:::::::::::::OO*P::::::PPPPPP:::::P*
M:::::::::M*********M:::::::::MO:::::::OOO:::::::OO:::::::OOO:::::::OPP:::::P*****P:::::P
M::::::::::M*******M::::::::::MO::::::O***O::::::OO::::::O***O::::::O**P::::P*****P:::::P
M:::::::::::M*****M:::::::::::MO:::::O*****O:::::OO:::::O*****O:::::O**P::::P*****P:::::P
M:::::::M::::M***M::::M:::::::MO:::::O*****O:::::OO:::::O*****O:::::O**P::::PPPPPP:::::P*
M::::::M*M::::M*M::::M*M::::::MO:::::O*****O:::::OO:::::O*****O:::::O**P:::::::::::::PP**
M::::::M**M::::M::::M**M::::::MO:::::O*****O:::::OO:::::O*****O:::::O**P::::PPPPPPPPP****
M::::::M***M:::::::M***M::::::MO:::::O*****O:::::OO:::::O*****O:::::O**P::::P************
M::::::M****M:::::M****M::::::MO:::::O*****O:::::OO:::::O*****O:::::O**P::::P************
M::::::M*****MMMMM*****M::::::MO::::::O***O::::::OO::::::O***O::::::O**P::::P************
M::::::M***************M::::::MO:::::::OOO:::::::OO:::::::OOO:::::::OPP::::::PP**********
M::::::M***************M::::::M*OO:::::::::::::OO**OO:::::::::::::OO*P::::::::P**********
M::::::M***************M::::::M***OO:::::::::OO******OO:::::::::OO***P::::::::P**********
MMMMMMMM***************MMMMMMMM*****OOOOOOOOO**********OOOOOOOOO*****PPPPPPPPPP**********
*****************************************************************************************
*****************************************************************************************
Matter Out Of Place - MOOP V3 - Cleaning Nature One Token At A Time
*/                                                                     
...
contract MOOP is ERC20, ERC20Permit, Ownable {
    address public constant feeAddress = 0xc4042DfAbF63F9d32849ca257b1EE1699a21a134;
        ...
        Ownable(msg.sender) 
    {
        ...
        isFeeExempt[0xE592427A0AEce92De3Edee1F18E0157C05861564] = true; // Uniswap Router
        exemptAddresses.push(msg.sender);
        exemptAddresses.push(0xE592427A0AEce92De3Edee1F18E0157C05861564);
    }
    ...
    function setFeeExempt(address account, bool exempt) public onlyOwner {
        ...
        if (exempt && !isFeeExempt[account]) {
            isFeeExempt[account] = true;
            exemptAddresses.push(account);
        } else if (!exempt && isFeeExempt[account]) {
            isFeeExempt[account] = false;
            for (uint256 i = 0; i < exemptAddresses.length; i++) {
                if (exemptAddresses[i] == account) {
    ...
    function getExemptCount() public view returns (uint256) {
        return exemptAddresses.length;
    }

    function getExemptAddress(uint256 index) public view returns (address) {
        require(index < exemptAddresses.length, "Index out of bounds");
        return exemptAddresses[index];
    }
}