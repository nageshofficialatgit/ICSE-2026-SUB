/*
    ...
    Twitter : http://x.com/caddyfi
    TG      : https://t.me/caddyfi
...
contract CaddyFinance is Ownable, ERC20 {
    ...
    constructor() Ownable(msg.sender) ERC20("Caddy Finance", "CADDY") {
    ...
    function clearStuckTokensCADDY(address _token) external onlyOwner {
        address owner = msg.sender;
        uint256 amount;
