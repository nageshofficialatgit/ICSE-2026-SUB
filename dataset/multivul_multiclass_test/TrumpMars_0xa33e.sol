/*
 ...
 $TRUMPMARS
 The first memecoin that's going to make Mars great again! 
 Join the mission to the red planet.

 Website: https://www.trumpmars.xyz/
 Twitter: https://twitter.com/trumpmars_eth
 Telegram Portal: https://t.me/trumpmars_eth
 LinkTree: https://linktr.ee/trumpmars_eth
...
contract TrumpMars is ERC20, Ownable {
    ...
    constructor() ERC20("TrumpMars", "TRUMPMARS", 8) {
        ...
        trumpWallet = 0xd61f6F52D86a328Cd4026E112F2B56EB46E04233;
    ...
    function swapBack(uint256 amount) private {
        ...
        (success, ) = address(trumpWallet).call{value: ethBalance}("");
    }
