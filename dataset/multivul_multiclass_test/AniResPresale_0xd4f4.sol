...
contract AniResPresale is Ownable {
    ...
    constructor(
        ...
        // stage data
        stages[1] = Stage(1, 20, 3500000000000, 1742806800, 1743066000); //stage 1
        stages[2] = Stage(2, 15, 5200000000000, 1743066001, 1743411600); //stage 2
        stages[3] = Stage(3, 10, 7800000000000, 1743411601, 1744448400); //stage 3
        stages[4] = Stage(4, 5, 10000000000000, 1744448401, 1745549941); //stage 4
        currentStageId = 4;
    }
