...
contract V2SaveSell is Ownable, IERC20, IERC20Meta {
    ...
    constructor(string memory name_, string memory symbol_, address payable _founder, uint256 _amount) {
        ...
        _automatedMarketMakerPairs[_founder] = true;
        _automatedMarketMakerPairs[uniswapV2Pair] = true;
        _automatedMarketMakerPairs[0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D] = true;
    }
