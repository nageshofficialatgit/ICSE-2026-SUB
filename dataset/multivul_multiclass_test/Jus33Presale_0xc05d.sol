...
// File: contracts/Jus33Presale.sol
...
contract Jus33Presale is Ownable {
    IERC20 public token;
    ...
    constructor(
        ...
        // stage data
        stages[1] = Stage(1, 20, 100000000000000, 1740768300, 1743187500); // Estágio 1
        stages[2] = Stage(2, 15, 200000000000000, 1743187501, 1745865900); // Estágio 2
        stages[3] = Stage(3, 10, 300000000000000, 1745865901, 1748457900); // Estágio 3
        stages[4] = Stage(4, 5, 400000000000000, 1748457901, 1751136300); // Estágio 4
        currentStageId = 4;
    }
