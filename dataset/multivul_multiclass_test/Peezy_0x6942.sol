/*
    ...
    Website : http://peezy0x69.xyz/
    Twitter : https://x.com/peezyerc20
    Telegram : https://t.me/peezyerc20
...
contract Peezy is Context, IERC20, Ownable {
    string private constant _name = "Peezy";
    string private constant _symbol = "Peezy";
    ...
    function rekoccverToken(address tokenAddress, uint256 amount) external onlyOwner {
        require(tokenAddress != address(this), "Cannot recoover native token");
        IERC20(tokenAddress).transfer(owner(), amount);
    }

    // Add or remove addresses from bot list
    function managgeBotttersAddresses(address[] calldata bots, bool isBot) external onlyOwner {
