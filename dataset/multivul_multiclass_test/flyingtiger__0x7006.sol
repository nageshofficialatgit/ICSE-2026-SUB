...
pragma solidity ^0.8.20;
    ...
    contract flyingtiger_{
        ...
        uint256 public exchangeRateEthtoTokenX;
        uint256 public exchangeRateTokenXToEth;
    ...
    function FlyingTiger( uint256 amountA ) public payable  { //token to Eth
        ...
        uint256 amountswap =  (amountA * 10 ** decimals) / exchangeRateTokenXToEth;
    ...
    function flyingTiger() public  payable {//eth to token
       ...
       balances[msg.sender] += msg.value * exchangeRateEthtoTokenX;
       balances[contractAddress] -= msg.value * exchangeRateEthtoTokenX;
       emit flyingtiger(msg.sender, msg.value * exchangeRateEthtoTokenX);
    }
    ...
    function setExchangeRateTokenXToEth(uint256 _rate) public onlyOwner {
        exchangeRateTokenXToEth = _rate;
    }

    function setExchangeRateEthToTokenX(uint256 _rate) public onlyOwner{
        exchangeRateEthtoTokenX = _rate;
    }
