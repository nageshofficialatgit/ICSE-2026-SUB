...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 public constant MAX_SUPPLY = 100_000_000 * 10**6; // 100 millones de tokens con 10 decimales
...
contract USDTv2 is ERC20 {
    ...
    uint256 public constant MAX_USDT_SUPPLY = 100_000_000 * 10**6; // 100 millones de tokens con 10 decimales
    ...
    constructor(address initialOwner) ERC20("USDTv2", "USDTv2", 6) Ownable() {
        ...
        mint(msg.sender, 10 ** 6 * 10 ** decimals()); // Initial supply for the owner
        totalMinted = 10 ** 6 * 10 ** decimals();
    }
