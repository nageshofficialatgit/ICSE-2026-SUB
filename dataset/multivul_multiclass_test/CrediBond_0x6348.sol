...
contract CrediBond is Ownable, ERC721, ERC721Burnable
{
    uint constant MAX_SUPPLY = 5000;
    uint private current_supply = 0;
    constructor() Ownable(_msgSender()) ERC721("DUNOTO PLC", "DPLC")
    { 
    }
    ...
    function mint(uint amount) external onlyOwner
    {
        ...
        {
            _safeMint(_msgSender(), ++current_supply);
        }
    }
    ...
    {
        _requireOwned(tokenId);
        return "ipfs://bafkreieueipd74ql3ed2geyg6vfpd666gnocxqcavtbwrrt4tc2mtkjnki";
    }
}