...
abstract contract SolMateERC20 {
    ...
    function transfer(address to, uint256 amount) public virtual returns (bool) {
        ...
        revert("$gin on ETH is migrating to BASE. We will airdrop you tokens on BASE. Please check Discord (https://discord.com/channels/1236397318148853781/1236414885932568627/1338176452138635264) or Telegram (https://t.me/TipsyCoinOfficial/101051).");
