...
contract DOGIUS is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dogius Maximusa";
    string private constant _symbol = "DOGIUS";
    ...
    function removeTrasnferTaxLimits() external onlyOwner{
        _transferTax = 0;
