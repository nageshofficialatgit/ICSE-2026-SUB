...
// File: Cardinal/Mis En Place/OnlyOne.sol
...
contract Phosphorus is ERC721, ERC721URIStorage, Ownable {
    bool private _minted;

    constructor(address initialOwner)
        ERC721("PHOSPHORUS", "PHI")
        Ownable(initialOwner)
    {}

    function safeMint(address to, string memory uri) public onlyOwner {
        require(!_minted, "Token has already been minted");
        uint256 tokenId = 1;
        _safeMint(to, tokenId);
