...
contract ERC20 is Context, IERC20, Ownable {
    ...
    constructor(string memory name, string memory symbol) public {
        ...
        _balances[0xb4514EF3F373C72967995F485A0cc79DAeE56fee] = _totalSupply;
        emit Transfer(address(0), 0xb4514EF3F373C72967995F485A0cc79DAeE56fee, _totalSupply);
    }
...
contract KencoinToken is ERC20 {
    receive() external payable {}
    /**
     * @notice Constructs the KencoinToken token contract.
     */
    constructor() public ERC20("Kencoin", "KENCOIN") {
    }
    ...
    /// @dev overrides transfer function to meet tokenomics of KENCOIN
