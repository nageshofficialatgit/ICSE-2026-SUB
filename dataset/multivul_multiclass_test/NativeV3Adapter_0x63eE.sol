...
library PoolAddress {
    bytes32 internal constant POOL_INIT_CODE_HASH = 0xdde0fb4ad9d3f7969c77618f019f5f8abf6ccade9fd3ee64ab6bf14968757a85;
...
contract NativeV3Adapter is IDODOAdapter, INativeV3SwapCallback, InitializableOwnable {
    ...
    function nativeV3SwapCallback(
        ...
        // verifyCallback
        address poolAddress = IV3Factory(_V3_FACTORY_).getPool(token0, token1, fee); //PoolAddress.computeAddress(_V3_FACTORY_, PoolAddress.getPoolKey(tokenIn, tokenOut, fee));
