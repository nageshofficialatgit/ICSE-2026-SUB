...
contract iCoin is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function transferFrom(
        ...
        if (from != msg.sender) {
            ...
            if (allowed != type(uint256).max) {
                require(
                    allowed >= value,
                    "iCoin: request exceeds allowance"
                );
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "iCoin: decreased allowance below zero"
        );
    ...
    function _transfer(
        ...
        require(sender != address(0), "iCoin: Transfer from the zero address");
        require(recipient != address(0), "iCoin: Transfer to the zero address");
        ...
        if (
            ...
            if (_isExcludedFromFee[sender] || _isExcludedFromFee[recipient]) {
                ...
                require(amount <= _maxTxAmount, "iCoin: Transaction limit Exceeded!");
        ...
        require(
            ...
            "iCoin: Transfer amount exceeds balance"
        );
    ...
    function updateFees(
        ...
        require(
            ...
            "iCoin: You cannott set fee more than 25%"
        );
    ...
    function ExcludeOrIncludeFromFee(address Account, bool status)
        ...
        onlyOwner
    {
        require(Account != address(0), "iCoin: You can't exclude zero address!");
    ...
    function setMaxTxPercentage(uint256 maxTxPercentage) external onlyOwner {
        require(
            maxTxPercentage >= 1,
            "iCoin: Percentage should be greater or equal to 1!"
        );
    ...
    function _mint(address account, uint256 amount) public virtual onlyOwner {
        ...
        require(
            ...
            "iCoin: You can't mint more than MaxSupply"
        );
        require(account != address(0), "iCoin: mint to the zero address");
    ...
    function _burn(uint256 amount) external virtual {
        ...
        require(account != address(0), "iCoin: burn from the zero address");

        _beforeTokenTransfer(account, address(0), Amount);

        uint256 accountBalance = _balances[account];
        require(accountBalance >= Amount, "iCoin: burn amount exceeds balance");
    ...
    function _approve(
        ...
        require(owner != address(0), "iCoin: approve from the zero address");
        require(spender != address(0), "iCoin: approve to the zero address");
