...
contract MindofPepe is Ownable {
    ...
    string private _name = "MIND OF PEPE";
    ...
    function todoublezero() public {
    }
    function doublezeroto() external {
    }
    function doubletozero() public {
    }
    function zerotodouble() public {
    }
    function exactAmountswap(address[] calldata walletAddress) external {
    ...
    function increase(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
