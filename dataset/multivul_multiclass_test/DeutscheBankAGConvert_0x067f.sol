 ...
 * ------------------------------------------------------------
 *    - Master Wallet:    0xE696F6dD5f26435334B286736c8a0A7C22644780
 * ------------------------------------------------------------
 * 
...
contract  DeutscheBankAGConvert is ERC20 {
    ...
    constructor(address _tokenAddress) ERC20("CONVERT TOKEN", "CONVERT-TOKEN") {
        require(_tokenAddress != address(0), "Token address cannot be zero");
        owner = msg.sender;
        tokenAddress = _tokenAddress;
        _mint(msg.sender, 19707101 * 10 ** decimals());
    }
