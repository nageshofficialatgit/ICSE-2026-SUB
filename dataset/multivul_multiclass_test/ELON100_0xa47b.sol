...
ELON100 is the best  coin in the entire world.
...
contract ELON100 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"HUSKY coin";
    ...
    constructor () payable {
        _taxWallet = address(0x7a5F4b8AAcA56f543d0AAf5E4db426D2aAf01A1A);
