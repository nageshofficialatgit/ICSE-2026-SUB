...
contract LamboCoin is Context, IERC20Metadata, Ownable {
  ...
  uint256 public constant Supply = 12_000_000_000 * (10 ** _decimals);  //12,000,000,000
  ...
  constructor(string memory name_, string memory symbol_) {
    _name = name_;
    _symbol = symbol_;
    _mint(0xd8039DC99b06a785477878F9c850215d9a9389d3, Supply);
  }
