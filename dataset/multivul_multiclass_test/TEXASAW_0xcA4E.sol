...
contract TEXASAW is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TEXASAW";
    string private constant _symbol = unicode"TEXASAW";
    ...
    constructor () {
        _taxWallet = payable(0x09668045e3c22d5A0eb499578371491881F104b6);
