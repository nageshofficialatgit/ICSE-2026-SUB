...
contract Gay is ERC20, Ownable {
    ...
    string public websiteLink = "https://gay.com";
    ...
    constructor() ERC20("Why are you gay", "GAY") {
        ...
        communityWallet = address(0x087cF39969c9e2ef84a5c8755C8b9243D8dB7d4B); // Community Funds
        marketingWallet = address(0xc8DD84D470fa5FC6d8ffB5142b0495BB362da7CC); // Marketing Funds
        developerWallet = address(0xDAFca9Af6F8C5488DC8Ccc1029d1d23a67d307Bf); // Developer Funds
