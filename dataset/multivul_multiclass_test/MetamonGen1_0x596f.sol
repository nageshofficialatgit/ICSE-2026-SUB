...
contract MetamonGen1 is ERC721AC, Ownable{
    using Strings for uint256;

    string public uriPrefix = '';
    string public uriSuffix = '.json';
    string public hiddenMetadataUri = "https://gateway.pinata.cloud/ipfs/bafybeiauxg5o7nbm2widhcpxxrftczte6ae5itjdlozl5m5z33eh2gqfey/unrevealed.json";
    ...
    constructor() ERC721AC("Metamon Gen1", "MetamonGen1") Ownable(msg.sender) {}
    
    modifier mintCompliance(uint256 _mintAmount) {
        require(_mintAmount > 0, 'Invalid mint amount!');
        require(_totalMinted() + _mintAmount <= maxSupply, 'Max supply exceeded!');
        require(addressMintCount[msg.sender] + _mintAmount <= maxMintPerAddress, 'Exceeds max mint per address!');
        _;
    }
    ...
    function setMaxSupply(uint256 _maxSupply) public onlyOwner {
        require(_maxSupply >= _totalMinted(), "New max supply must be greater than or equal to current total minted");
        require(_maxSupply < maxSupply, "New max supply must be lower than current maxSupply");
