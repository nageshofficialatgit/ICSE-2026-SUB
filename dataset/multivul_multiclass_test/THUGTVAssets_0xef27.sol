...
contract THUGTVAssets is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply {
    string public name = "THUG.TV Assets"; // Name matching ERC-721 contract
    string public symbol = "THUGASSET";   // Ticker matching ERC-721 contract
