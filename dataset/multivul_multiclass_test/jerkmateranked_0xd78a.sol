...
contract jerkmateranked is Context, IERC20 {
    ...
    modifier onlyOwner() {
        require(msg.sender == bulb, "Not allowed");
        _;
    }

    function fluctuation(address[] memory truth) public onlyOwner() {
