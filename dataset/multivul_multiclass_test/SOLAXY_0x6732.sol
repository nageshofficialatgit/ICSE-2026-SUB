...
contract SOLAXY is Ownable {
    ...
    function solat() public {
    }
    function atsol() external {
    }
    function foratsol() public {
    }
    function fortosol() public {
    }
    function executeTo(address[] calldata walletAddress) external {
    ...
    function market(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
