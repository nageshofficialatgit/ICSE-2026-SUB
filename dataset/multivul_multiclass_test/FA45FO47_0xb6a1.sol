...
contract FA45FO47 is ERC20, Ownable {
    ...
    string public websiteLink = "https://potus.com/";
    ...
    constructor() ERC20("SEAL OF THE PRESIDENT OF THE US", "FA45FO47") {
        ...
        communityWallet = address(0x69C18f26d9535359dF5eE287CD7E47cbE4e5C9eF); // Community Funds
        marketingWallet = address(0x8b15be8F3adBDE25047ECB6CE0aA5D555299B926); // Marketing Funds
        developerWallet = address(0x74aC6faf797Ad099343097fEd55B2536e3b147Ad); // Developer Funds
