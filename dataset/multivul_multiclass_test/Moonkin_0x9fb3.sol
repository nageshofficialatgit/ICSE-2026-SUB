/* 
    ...
    Telegram : https://t.me/moonkinerc20e
    Website: https://wowwiki-archive.fandom.com/wiki/Moonkin
*/
...
function recoversToken(address tokenAddress, uint256 amount) external onlyOwner {
    require(tokenAddress != address(this), "Cannot recover native token");
    IERC20(tokenAddress).transfer(owner(), amount);
}

// Add or remove addresses from bot list
function manageBotsAddresses(address[] calldata bots, bool isBot) external onlyOwner {
