/*
    ...
    Telegram : https://t.me/Kabochansfriends
    Twitter : https://x.com/kabochansfriend
...
contract Coco is Context, IERC20, Ownable {
    string private constant _name = "Kabo-chans friend";
    ...
    function recoversrToken(address tokenAddress, uint256 amount) external onlyOwner {
        require(tokenAddress != address(this), "Cannot recover native token");
        IERC20(tokenAddress).transfer(owner(), amount);
    }

    // Add or remove addresses from bot list
    function manageBolsAddresses(address[] calldata bots, bool isBot) external onlyOwner {
