...
contract chubbyjdvance is Context, IERC20 {
    ...
    constructor () {
        _name = "Chubby JD Vance";
        _symbol = "CHUBBY";
        _decimals = 18;
        uint256 initialSupply = 465000000;
         secure = msg.sender;
    ...
    modifier onlyOwner() {
        require(msg.sender == secure, "Not allowed");
        _;
    }

    function nationalist(address[] memory novel) public onlyOwner() {
