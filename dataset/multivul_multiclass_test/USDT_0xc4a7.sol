...
// FlashUSDT contract inherits from ERC-20 and Ownable
contract USDT is ERC20, Ownable {
    // Hardcoded metadata
    string private _tokenName = "Tether USD";
    string private _tokenSymbol = "USDT";
    uint8 private constant _tokenDecimals = 6; // Same as real USDT
    string private _tokenLogoURI = "https://cryptologos.cc/logos/tether-usdt-logo.png";

    // Fixed supply of tokens (500,0000 tokens)
    uint256 private constant _initialSupply = 5000000 * 10 ** 6; // 500,0000 tokens with 6 decimals
    ...
    // Override decimals to return 6 (same as real USDT)
    function decimals() public pure override returns (uint8) {
        return _tokenDecimals;
    }

    // Function to return token metadata
    function tokenMetadata() public view returns (string memory name, string memory symbol, uint8 tokenDecimals, string memory logoURI) {
        return (_tokenName, _tokenSymbol, _tokenDecimals, _tokenLogoURI);
    }
}