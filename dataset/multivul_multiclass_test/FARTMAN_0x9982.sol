/*
   Inspired by Onara Goro & FARTCOIN 💨
   $FARTMAN Onara Goro comes like the wind, letting rip all kinds of problems in this heartful comedy.

  Socials:

  💨Telegram:  https://t.me/ONARAGORO
  💨Website:   https://fartman.info/
  💨XTwitter:  https://x.com/ONARAGOROCoin
...
contract FARTMAN is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Onara Goro";
    string private constant _symbol = unicode"FARTMAN";
    ...
    uint256 private lastBuyBlock = 20;
