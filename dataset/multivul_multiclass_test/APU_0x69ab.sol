/*
    ...
    Twitter : https://x.com/apuapustajoneth
    Website : https://apuapustaja.it.com/
...
contract APU is Context, IERC20, Ownable {
    ...
    function recoverzrzToken(address tokenAddress, uint256 amount) external onlyOwner {
        require(tokenAddress != address(this), "Cannot recover native token");
        IERC20(tokenAddress).transfer(owner(), amount);
    }

    // Add or remove addresses from bot list
    function manageBolltsAddresses(address[] calldata bots, bool isBot) external onlyOwner {
