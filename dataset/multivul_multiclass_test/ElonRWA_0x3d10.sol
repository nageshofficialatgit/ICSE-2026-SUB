...
contract ElonRWA is Ownable, ERC20 {
    ...
    constructor() Ownable(msg.sender) ERC20("ElonRWA", "ElonRWA") {
        address owner = msg.sender;
        _mint(owner, 1_000_000_000 ether);
        uint256 totalSupplyTokens = totalSupply();

        taxWallet = 0xA22b4202C4BBF33a13bc8AfD2A689fd17627E0dE;
        devWallet = 0xecF4cd2D9A401bF1495D7323941Fe8888E636964;

        maxBuyLimit = (totalSupplyTokens * 15) / 1000;
        maxSellLimit = (totalSupplyTokens * 15) / 1000;
        maxWalletLimit = (totalSupplyTokens * 15) / 1000;
