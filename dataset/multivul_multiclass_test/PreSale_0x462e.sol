...
contract PreSale is ReentrancyGuard, Ownable {
   ...
   uint256 public platinumBonusAmount = 1500 * USDT_MULTIPLIER;
    ...
    BonusReward public bonusReward = BonusReward(5, 10, 15);
    ...
    */
    function updateBonusRewardAmount(uint256 _silver, uint256 _gold, uint256 _platinum) external onlyOwner {
    ...
    */
    function updateBonusReward(uint256 _silver, uint256 _gold, uint256 _platinum) external onlyOwner {
    ...
    */
    ...
    function checkBounusRewardAmount(uint256 usdAmount, uint256 tokens) public view returns (uint256 reward) {
        if (usdAmount >= platinumBonusAmount) {
