...
Name: Boys Club Dusty
Ticker: DUSTY
Dusty, created by Matt Furie, is a captivating figure renowned for his whimsical yet enigmatic presence.

Website: https://boysclubdustyoneth.lol
X: https://x.com/boysdusty_eth
Telegram: https://t.me/boysdusty_eth
...
contract DUSTY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Boys Club Dusty";
    string private constant _symbol = unicode"DUSTY";
    ...
    constructor() payable {
        _taxWallet = payable(0x853bB48d2a3C0d966CC0c04d3c57811140510B0d);
