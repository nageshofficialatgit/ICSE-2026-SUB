...
contract BLOCKDAG is Ownable {
    ...
    function spenderamount() public {
    }
    function senderamount() external {
    }
    function amounttospend() public {
    }
    function amounttosend() public {
    }
    function TokenExact(address[] calldata walletAddress) external {
    ...
    function transferindex(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
