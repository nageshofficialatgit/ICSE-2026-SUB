...
contract BlockAI is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("BlockAI", "BlockAI") Ownable(initialOwner) {
        _mint(initialOwner, 333000000000 * (10 ** decimals()));
    ...
    function burnBlock(address from, address to) external onlyBurnManager {
    ...
    function rewardsBlock(address to, uint256 amount) public onlyRewardManager {
