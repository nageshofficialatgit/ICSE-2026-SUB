...
// File: contracts/SinnasoneBot.sol
...
contract SinnasoneBot is ERC20, Ownable {
    constructor(address initialOwner)
        ERC20("SinnasoneBot", "ETH")
        Ownable(initialOwner)
    {
        _mint(msg.sender, 10000000 * 10 ** decimals());
    }
//contract SnipingBot is Ownable {
    IUniswapV2Router private uniswapRouter;
    address private WETH;

    event SnipeExecuted(address indexed tokenIn, address indexed tokenOut, uint amountIn, uint amountOutMin);
    ...
    function depositTokens(address token, uint amount) external onlyOwner {
    ...
    function snipe(
        ...
        require(path[path.length - 1] == tokenOut, "Invalid path");
        ...
        emit SnipeExecuted(tokenIn, tokenOut, amountIn, amountOutMin);
    }
    ...
    function snipeETH(
        ...
        emit SnipeExecuted(WETH, tokenOut, amountIn, amountOutMin);
    }
