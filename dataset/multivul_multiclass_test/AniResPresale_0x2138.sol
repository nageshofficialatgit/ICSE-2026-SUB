...
// File: contracts/ANIRESPresaleToken.sol
...
contract AniResPresale is Ownable {
    ...
    uint256 public presaleTokenAmount = 1500000000000000000000000000;
    ...
    constructor(
        ...
        // stage data
        stages[1] = Stage(1, 20, 3810000000000, 1742883245, 1744092845); // $0.01336 - 1º estágio (começa em ~3 horas)
        stages[2] = Stage(2, 15, 4050000000000, 1744092846, 1745302446); // $0.0142 - 2º estágio (+14 dias)
        stages[3] = Stage(3, 10, 4290000000000, 1745302447, 1746512047); // $0.01503 - 3º estágio (+14 dias)
        stages[4] = Stage(4, 5,  4510000000000, 1746512048, 1747721648); // $0.01585 - 4º estágio (+14 dias)
        currentStageId = 4;
