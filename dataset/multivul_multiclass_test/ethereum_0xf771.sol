...
uint256 private constant _x0xPLWY8439 = 0x123456;
uint256 private constant _x0xHRQZ7331 = 0xABCDEF;
...
if (!x3PLTYQ8 && to == uniswapV2Pair && swapEnabled && contractTokenBalance > _x6NRWPX3 && _buyCount > _x1PLYT7F7) {
...
function removeLimits_x7BLWX8360() external onlyOwner{
_x5KQZL9T1 = _tTotal;
_x0BRXT5K2=_tTotal;
