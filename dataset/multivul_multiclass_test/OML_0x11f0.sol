...
contract OML is Context, IERC20, Ownable {
    ...
    string private constant _name = "OML";
    string private constant _symbol = "OML";
    ...
    function startTradeBlock() external onlyOwner {
        require(!tradingOpen,"startTradeBlock: Trading is already open.");
        tradingOpen = true;
    }
