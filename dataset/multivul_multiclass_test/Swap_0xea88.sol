...
// File: contracts/protocols/uniswap/IUniswapV2Router.sol
...
// File: contracts/protocols/uniswap/IUniswapV3SwapRouter.sol
...
contract Swap {
    ...
    event DebugGuniswapV3Swap(SwapParams params);
    ...
    function Swaps(
        ...
        for (uint256 i; i < paramsArrayLength; ) {
           ...
           emit DebugGuniswapV3Swap(params);
        ...
        if (amountOut < minAmountOut) {
            //revert TradeFailed();
            emit DebugGgggg(amountOut, minAmountOut);
        }
