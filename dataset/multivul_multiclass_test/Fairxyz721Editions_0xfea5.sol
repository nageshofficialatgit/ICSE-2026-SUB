...
// src/fair/Editions/FairxyzEditionsConstants.sol
...
// src/fair/OperatorFilterRegistry/IOperatorFilterRegistry.sol
...
// src/fair/OperatorFilterRegistry/OperatorFilterRegistryErrorsAndEvents.sol
...
// src/fair/interfaces/IFairxyz721Editions.sol
...
// src/fair/interfaces/IFairxyzOperatorFiltererUpgradeable.sol
...
// src/fair/interfaces/ITokenURI.sol
...
// src/fair/interfaces/IERC2981Upgradeable.sol
...
// src/fair/OperatorFilterRegistry/OperatorFilterRegistry.sol
...
// src/fair/FairxyzOperatorFiltererUpgradeable.sol
...
// src/fair/Fairxyz721Upgradeable.sol
 ...
 * {ERC721Enumerable}.
 */
abstract contract Fairxyz721Upgradeable is
    Initializable,
    ContextUpgradeable,
    ERC165Upgradeable,
    IERC721Upgradeable,
    IERC721MetadataUpgradeable
{
    ...
    function __Fairxyz721_init(
        ...
        __Fairxyz721_init_unchained(name_, symbol_);
    }
...
// src/fair/Editions/FairxyzEditionsBaseUpgradeable.sol
...
// src/fair/Editions/FairxyzEditionsUpgradeable.sol
...
// src/fair/Fairxyz721Editions.sol
    ...
    FairxyzEditionsUpgradeable
{
     ...
     * @param treasury_ The address which should receive the default royalty.
     ...
     * @param defaultMintingExtension The default minting extension enabled from deployment
     * @param defaultRoyaltyExtension The default royalty extension enabled from deployment
     */
    function initialize(
        string memory name_,
        string memory symbol_,
        ...
        address defaultMintingExtension,
        address defaultRoyaltyExtension
    ) external initializer {
        __Fairxyz721_init(name_, symbol_);
        __FairxyzEditions_init(
            owner_,
            defaultMintingExtension,
            defaultRoyaltyExtension
        );
        ...
        _setDefaultRoyalty(treasury_, defaultRoyalty_);
    }
    ...
    function tokenURI(
        ...
        if (_editionURIExtension[editionId] != address(0)) {
            uri = ITokenURI(_editionURIExtension[editionId]).tokenURI(tokenId);
        } else {
            uri = _tokenURI[tokenId];
        }
