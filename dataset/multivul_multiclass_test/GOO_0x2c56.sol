...
contract GOO is Context, Ownable, IERC20 {
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;  
    mapping (address => uint256) private _transferFees; 
     uint8 private constant _decimals = 9;  
    uint256 private constant _totalSupply = 10000000000* 10**_decimals;
    string private constant _name = unicode"gate of olympus 1000";
    string private constant _symbol = unicode"GOO 1000";
    address constant private _marketwallet=0x548EaAC6B2c9b346C1F7D49Fc11c2BDe9CD31929;
