/*
    XORAI
    An AI-powered social media platform integrated with Xorai Smart Chain (XRC)
    offering decentralized and intelligent digital interactions.
    Website     : https://xorai.net/
    Telegram    : https://t.me/XoraiAi
    X           : https://x.com/Xorai_ai
*/
...
contract XoraiBlockhain is Context , IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 100000000 * 10**_decimals; // 100 million supply
    string private constant _name = "Xorai Blockchain" ;
    ...
    uint256 public _maxTaxSwap= 1870004 * 10**_decimals;
