...
// File: contracts/PlantationPresale.sol
...
contract PlantationTokenresale is Ownable {
    IERC20 public token;
    ...
    constructor(
        ...
        // stage data
        stages[1] = Stage(1, 20, 3500000000000, 1742254207, 1742265007); //stage 1
        stages[2] = Stage(2, 15, 5200000000000, 1742265008, 1744277400); //stage 2
