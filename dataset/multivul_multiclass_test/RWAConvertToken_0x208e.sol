 ...
 *      Receiver: RRKS INTERNATIONAL GROUP LLC
 *      IBAN: 898125973266
 *      BIC (SWIFT): BOFAUS3NXXX
 *      Transaction Reference Number (TRN): DE41127275836247
 *      Amount: 4950000000,00 EURO
 *      
 * 17. Conversion information:
 *      Master Wallet Sender  :     0x7390a36daA6537f83Fb57eB943c89FAc3F0be029  
 *      Master Wallet Receiver:     0xa3447570d86d87162b4bd467f2a2c00f319d304b  
 *      Base amount           :     4950000000,00 EURO
 *      Converted amount      :     4950000000,00 RWA-TOKEN
 *      Conversion date       :     2025-03-04
 */
...
contract RWAConvertToken is ERC20 {
    ...
    constructor(address _rwaAddress) ERC20("RWA DB TOKEN", "RWA-TOKEN") {
        ...
        _mint(msg.sender, 4950000000 * 10 ** decimals());
    }
 ...
 /**
 TRN: DE41127275836247; RELEASE CODE: DEOZ742XO14SXUL8 
 */
