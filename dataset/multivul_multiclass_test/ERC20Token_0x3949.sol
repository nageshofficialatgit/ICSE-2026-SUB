...
/*---------------------------------------
Hedge Stake USD (sUSDH)
Hybrid asset Stable coin / Protocol Hedge Stable Finance
Token Decentralized Ecosystem Hedge / Hybrid asset
Asset / stable collateral Protocol Hedge
Share of automatic market maker, hedging synthetic
The Unified Hedge Ecosystem & Institutional Hedge Platform

------------------------------------------

Decentralized ecosystem Hedge
...
contract ERC20Token is IERC20, SafeMath {
    ...
    constructor() {
        name = "Hedge Stake USD";
        symbol = "sUSDH";
        decimals = 18;
        _totalSupply = 1403494557 * 10**18;

        _admin = 0xE0ec33fF5cA9db4156F8A29D8FC69F30D7881512; // admin account
