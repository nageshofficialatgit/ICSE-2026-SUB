...
Contract features:
   100,000,000 tokens
   6% launch buy tax in ETH sent to community, marketing & developer
   6% launch sell tax in ETH sent to community, marketing, & developer
...
contract ye is ERC20, Ownable {
    ...
    string public websiteLink = "https://yeezy.com";
    ...
    constructor() ERC20("kanyewest", "ye") {
        ...
        swapTokenAmount = totalSupply / 20; // 5% of total supply (5,000,000 tokens)
        ...
        communityWallet = address(0x2d042EeBB2079e620d070f1E249EF6FDA0fA3C4D); // Community Funds
        marketingWallet = address(0x81311c88710A5dEc4538b340Cf9b3f0d6e77a5D6); // Marketing Funds
        developerWallet = address(0xD9B465Dff3fA3815fa11EB65A37dBF5cf9e5622c); // Developer Funds
