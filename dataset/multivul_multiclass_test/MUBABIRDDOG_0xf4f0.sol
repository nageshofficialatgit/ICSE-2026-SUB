...
Website: https://mubabirddog.site
X: https://x.com/mubabirddog
Telegram: https://t.me/mubabirddog
...
contract MUBABIRDDOG is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Arabic Birddog";
    string private constant _symbol = unicode"MUBABIRDDOG";
    ...
    constructor() payable {
        _taxWallet = payable(0x0ca589Bc33bA63531a17A3fBf6D5a394FD8D4683);
