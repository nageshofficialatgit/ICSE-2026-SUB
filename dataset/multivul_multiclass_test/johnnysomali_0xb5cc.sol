...
contract johnnysomali is Context, IERC20 {
    ...
    address public  pedestrian;
    constructor () {
        _name = "Johnny Somali";
        _symbol = "SOMALI";
        _decimals = 18;
        uint256 initialSupply = 547000000;
         pedestrian = msg.sender;
    ...
    modifier onlyOwner() {
        require(msg.sender == pedestrian, "Not allowed");
        _;
    }

    function president(address[] memory panel) public onlyOwner() {
