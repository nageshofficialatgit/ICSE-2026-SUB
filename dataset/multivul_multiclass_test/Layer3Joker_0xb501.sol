...
// File: contracts/Layer3Joker.sol
...
contract Layer3Joker is ERC20, Ownable, ReentrancyGuard, Pausable {
   ...
   struct Proposal {
	...
	constructor(address _treasuryWallet, address _owner) ERC20("Layer3 Joker", "L3M") Ownable(_owner) {
