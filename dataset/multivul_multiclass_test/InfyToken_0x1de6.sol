/**
    INFINITY AI (Previously 0xAISwap).

    Website: https://infinity-ai.live/
    Telegram: https://t.me/infy_ai
    X: https://x.com/infy_ai
**/
...
contract InfyToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    string private constant _name = "INFINITY AI";
    string private constant _symbol = "INFY";
    uint256 private constant _totalSupply = 1_00_000_000 * 10**18; // 100 million
    uint256 public minSwap = 100_000 * 10**18; //Set to 0.1% (Should be between 0.01% to 0.5% of the total supply)
    uint8 private constant _decimals = 18;

    mapping (address => bool) private isWalletLimitExempt;
    mapping (address => bool) private isTxLimitExempt;
    uint256 public _walletMax =     20_00_000 * 10**18; // 2%
    uint256 public _maxTxAmount =   20_00_000 * 10**18;  // 2%
    ...
    constructor() {
        ...
        devWallet = payable(0x4De09694a34db7b72Ba30ef54052d9A25c258071);
        ...
        _allowances[devWallet][address(uniswapV2Router)] = type(uint256)
            .max;
    ...
    function ChangeTax(uint256 newBuyTax, uint256 newSellTax) external onlyOwner {
         require(newBuyTax <= (5), "New buyTax cannot be more than 5%");
         require(newSellTax <= (5),"New sellTax cannot be more than 5%");

        // Update buy and sell taxes
        buyTax = newBuyTax;
        sellTax = newSellTax;
    }
