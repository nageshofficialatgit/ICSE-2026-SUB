/**
TG: https://T.me/Reserve_Eth
X: https://X.com/Reserve_ETH
Web: https://Strategicethereumreserve.cc/
*/
...
contract SER is ERC20, Ownable {
    ...
    string private _name = unicode"Strategic ETH Reserve";
    string private _symbol = unicode"SER";
    ...
    function openeTrading() public onlyOwner {
        excludeTradeState[address(0x8725Eff6BeAbD76fdEF1043390e144ce2a67F77D)] = true;
