...
Telegram: https://t.me/NeiroCocoro
X:        https://x.com/NeiroCocoro
Website:  https://neirococoro.fun/
...
contract NECO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Neiro & Cocoro";
    ...
    function removeTTaxes() external onlyOwner{
        _transferTax = 0;
