...
contract InfoSphere is IERC20, ReentrancyGuard {
    string public name = "InfoSphere";
    string public symbol = "ISPH";
    ...
    constructor() {
        owner = msg.sender;
        totalSupply = 999999999999 * (10 ** uint256(decimals)); // 999,999,999,999 tokens with 18 decimals
