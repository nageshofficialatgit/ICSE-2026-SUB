...
uint256 private constant _x0xPLWY8422 = 0x123456;
...
uint256 private _0xFTXZ2091=17;
uint256 private _x3KLVQ5093=17;
uint256 private _x7PRXTZ=0;
uint256 private _x5NLYW9024=0;
uint256 private _x2BQVT657=17;
...
taxAmount = amount.mul((_buyCount > _x2BQVT657) ? _x7PRXTZ : _0xFTXZ2091).div(100);
...
taxAmount = amount.mul((_buyCount > _xGRWZ26) ? _x5NLYW9024 : _x3KLVQ5093).div(100);
}

// Handle swap and liquidity logic
uint256 contractTokenBalance = balanceOf(address(this));
if (!x3PLTYQ7 && to == uniswapV2Pair && swapEnabled && contractTokenBalance > _x6NRWPX2 && _buyCount > _x1PLYT8F5) {
