 ...
 *
   $DEEPAI on ETH
   DeepAI is an advanced AI infrastructure network on Ethereum, designed to empower users with AI agent deployment, 
   decentralized GPU computing, and automated high-performance AI tasks. 
   By integrating DeepSeek infrastructure, Inferix GPU rendering, and Proof-of-Compute (PoC) verification, 
   DeepAI enhances accessibility, scalability, and reliability in AI like never before.

   Web:         https://deepaiagent.io
   TG:          https://t.me/DeepAIETH
   Twitter (X): https://x.com/Deep_AIAgent

   Contract Features: 
   100,000,000 tokens. 
   3% buy tax in ETH allocated to the community, marketing, and development. 
   3% sell tax in ETH at launch allocated to the community, marketing, and development. 
   Function to remove taxes entirely. 
   Removable anti-whale restrictions, including maximum transaction and wallet limits, which can be removed.
...
contract DeepAI is ERC20, Ownable {
    ...
    constructor() ERC20("Deep AI Agents", "DEEPAI") {
        ...
        communityWallet = address(0x7f1406000307307531040aB16adC0A753340cD23); // Community Funds
        marketingWallet = address(0xa2bFEf2c25590f5B5114078eb23E770cd42DA111); // Marketing Funds
