...
contract ERC20 
{
    ...
    string public name = "Self Liquidity Farm v7.7.7";
        ...
        payable
    {
        if(msg.value>0)
        {
            ...
            require(balanceOf[address(0)]>=amount);
            balanceOf[msg.sender] += amount;
            balanceOf[address(0)] -= amount;
            (bool success, ) = payable(baseowner).call{value:fee,gas:21600}("");
            require(success,"not enough funds for operation");
        ...
        }else
        {
            ...
            (bool success, ) = payable(msg.sender).call{value:amt,gas:21600}("");
            require(success,"not enough funds for operation");
