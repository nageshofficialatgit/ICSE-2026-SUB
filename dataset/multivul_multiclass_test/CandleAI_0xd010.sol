...
/*
$CNDL powers an algorithmic trading dApp that transforms the uncertain nature of DEX trading into an automated, profitable experience.

Website:    https://cndl.ai/
Telegram:   https://t.me/candle_AI/
X:          https://x.com/cndl_ai/
...
contract CandleAI is ERC20, Ownable {
    ...
    uint256 public taxSwapThreshold = (initialTotalSupply * 10)/1000;
    ...
    constructor() ERC20("CandleAI", "CNDL"){
        _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        marketingWallet = payable(0xdd43CB63b17a251581DA3B3bBC0Ed10f81b12532);
        ...
        // mint
        _mint(msg.sender, (initialTotalSupply * 785)/1000);
        _mint(marketingWallet, (initialTotalSupply * 200)/1000);
        _mint(address(0xdead), (initialTotalSupply * 15)/1000);
    ...
    function addLiquidity() external onlyOwner() {
        ...
        _uniswapV2Router.addLiquidityETH{value: address(this).balance}(
            ...
            0,
            0,
            0xb258B7fd7d26C3a5Ab2791a89dD47D1D37E40964,
            block.timestamp
        );
    ...
    function exempt(address account, bool excluded) public onlyOwner {
        _isExcludedFromFees[account] = excluded;
        emit ExcludeFromFees(account, excluded);
    }

    function reduceFee(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        sellFee = _sellFee;
        buyFee = _buyFee;
    }
    ...
    function swapBack() private {
        ...
        if (tokensToSwap > taxSwapThreshold) {
            tokensToSwap = taxSwapThreshold;
        }
