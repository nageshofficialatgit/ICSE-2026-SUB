...
// File: contracts/AssoulZNFTs.sol
...
contract MyToken is ERC721, ERC721Pausable, Ownable {
    ...
    // Safe minting of a token with automatic tokenId generation
    ...
    // Transfer token to another address (only token owner)
    function transferToken(address to, uint256 tokenId) public {
        safeTransferFrom(msg.sender, to, tokenId);
    }

    // Override for compatibility with ERC721Pausable
    function _update(
        address to,
        uint256 tokenId,
        address auth
