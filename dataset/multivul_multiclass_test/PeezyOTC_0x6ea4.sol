...
contract PeezyOTC {
    ...
    // Maximum USD amount (with 18 decimals) allowed per swap.
    ...
    function getPeezy() external payable onlyWhitelist {
        ...
        // Calculate the maximum allowed ETH (in wei) based on the USD limit.
    ...
    // Update the maximum allowed USD amount per swap.
