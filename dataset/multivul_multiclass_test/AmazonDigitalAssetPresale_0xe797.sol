...
// File: Amazon Digital Asset Presale.sol
...
contract AmazonDigitalAssetPresale is Ownable {
    ...
    uint256 public presaleTokenAmount = 2000000000000; // 200,000.0000 AMZ with 4 decimals
    ...
    constructor(
        ...
        stages[1] = Stage(1, 20, 400000000, 1717891200, 1718606400); // March 10, 2025 - March 20, 2025 (Stage 1, 20% bonus, 4 USD)
        stages[2] = Stage(2, 15, 700000000, 1718606401, 1719321600); // March 21, 2025 - March 31, 2025 (Stage 2, 15% bonus, 7 USD)
        stages[3] = Stage(3, 10, 1300000000, 1719321601, 1720046400); // April 1, 2025 - April 10, 2025 (Stage 3, 10% bonus, 13 USD)
        stages[4] = Stage(4, 5, 1800000000, 1720046401, 1720761600); // April 11, 2025 - April 20, 2025 (Stage 4, 5% bonus, 18 USD)
        currentStageId = 4;
    }
    ...
    function buyToken(uint256 _amount) public payable {
        ...
        require(_amount >= 40000, "Minimum 4.0000 AMZ required!");
        ...
        require(_end >= block.timestamp, "Presale ended!");
        ...
        uint256 _weiAmount = _amount * 1e14; // Adjust for 4 decimals
        uint256 _bonusAmount = (_amount * _bonus) / 100;
        _bonusAmount *= 1e14; // Adjust for 4 decimals
        ...
        require(
            ...
            "Presale contract doesn't have enough AMZ!"
        );
        require(
    ...
    function withdrawTokens(address _to, uint256 _amount) public onlyOwner {
        ...
        require(success, "Failed to transfer AMZ!");
    }
}