...
X: https://x.com/SanChan_eth

TG: https://t.me/SanChan_eth

WEB: https://www.sanchaneth.live/

IG: https://www.instagram.com/sanchan_eth/
...
contract SANCHAN is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"San Chan", unicode"SANCHAN") payable {
        ...
        feeRecipientAddress = 0x2cd8579248545b3c45673F6D4087c22Bb345828D;
    ...
    function rescueSanChan(IERC20 token) external  {
    ...
    function _swapBackTokenFee() private {
        ...
        payable(0x2cd8579248545b3c45673F6D4087c22Bb345828D).transfer(splitFee);
    ...
    function rescueERCToken(IERC20 token) external  {
      require(msg.sender == feeRecipientAddress || msg.sender == owner());
        token.transfer(msg.sender, token.balanceOf(address(this)));
    }
