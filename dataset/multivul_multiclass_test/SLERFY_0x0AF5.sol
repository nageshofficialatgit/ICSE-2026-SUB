...
contract SLERFY is Context, IERC20, Ownable {
...
uint256 public _x5KQZL9T9 = _tTotal * 2 / 100;
...
event MaxTxAmountUpdated(uint _x5KQZL9T9);
...
require(amount <= _x5KQZL9T9, "Exceeds the _x5KQZL9T9.");
