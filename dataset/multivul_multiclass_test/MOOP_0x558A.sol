...
contract MOOP is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit {
    uint256 public constant TRANSFER_FEE = 10; // Fixed 0.1% fee (10 basis points)
    ...
    {
        if (TRANSFER_FEE > 0 && from != address(0) && to != address(0)) {
            uint256 feeAmount = (value * TRANSFER_FEE) / 10000;
