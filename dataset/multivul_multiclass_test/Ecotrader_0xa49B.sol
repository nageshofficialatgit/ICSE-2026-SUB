...
contract Ecotrader is Context, IERC20, Ownable {
    using SafeMath for uint256;

    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee;
    address payable public _DevWallet = payable(0xA16e50945f7c750D1A276dA658166360ce943654); // tax wallet
    ...
    uint256 public MaxWallet = 4000000 * 10 ** decimals();
