...
contract CMC is Context, IERC20, IERC20Metadata, Ownable {
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "CMC: decreased allowance below zero"
        );
    ...
    function _transfer(
        ...
        require(sender != address(0), "CMC: Transfer from the zero address");
        require(recipient != address(0), "CMC: Transfer to the zero address");
        ...
        if (
            ...
            if (_isExcludedFromFee[sender] || _isExcludedFromFee[recipient]) {
                ...
                require(amount <= _maxTxAmount, "CMC: Transaction limit Exceeded!");
        ...
        require(
            ...
            "CMC: Transfer amount exceeds balance"
        );
    ...
    function updateFees(
        ...
        require(
            ...
            "CMC: You cannott set fee more than 25%"
        );
    ...
    function ExcludeOrIncludeFromFee(address Account, bool status)
        ...
        onlyOwner
    {
        require(Account != address(0), "CMC: You can't exclude zero address!");
    ...
    function setMaxTxPercentage(uint256 maxTxPercentage) external onlyOwner {
        require(
            maxTxPercentage >= 1,
            "CMC: Percentage should be greater or equal to 1!"
        );
    ...
    function _mint(address account, uint256 amount) public virtual onlyOwner {
        ...
        require(
            ...
            "CMC: You can't mint more than MaxSupply"
        );
        require(account != address(0), "CMC: mint to the zero address");
    ...
    function _burn(uint256 amount) external virtual {
        ...
        require(account != address(0), "CMC: burn from the zero address");

        _beforeTokenTransfer(account, address(0), Amount);

        uint256 accountBalance = _balances[account];
        require(accountBalance >= Amount, "CMC: burn amount exceeds balance");
    ...
    function _approve(
        ...
        require(owner != address(0), "CMC: approve from the zero address");
        require(spender != address(0), "CMC: approve to the zero address");
