...
contract LEXAI is Context, IERC20, Ownable {
    ...
    uint256 private _reduceBuyTaxAt=63;
    uint256 private _reduceSellTaxAt=63;
    ...
    constructor () {
        _taxWallet = payable(0x5ce1289e8f148944fa3B8452d227092e3e1D7ce3);
