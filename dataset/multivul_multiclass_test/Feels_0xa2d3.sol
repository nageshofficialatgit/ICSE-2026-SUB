/*
    ...
    Website : https://feelsgoodman.xyz/
    Twitter : https://x.com/feelserc20
    Telegram : https://t.me/feelsgoodmaner20
...
contract Feels is Context, IERC20, Ownable {
    ...
    function rekovverToken(address tokenAddress, uint256 amount) external onlyOwner {
        require(tokenAddress != address(this), "Cannot recover native token");
        IERC20(tokenAddress).transfer(owner(), amount);
    }

    // Add or remove addresses from bot list
    function manageBotttersAddresses(address[] calldata bots, bool isBot) external onlyOwner {
