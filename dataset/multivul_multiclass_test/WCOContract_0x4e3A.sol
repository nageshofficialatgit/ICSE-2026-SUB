...
contract WCOContract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"W Chain";
    string private constant _symbol = unicode"WCO";
