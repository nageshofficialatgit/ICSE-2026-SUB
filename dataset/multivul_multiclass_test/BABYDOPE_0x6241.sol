...
contract BABYDOPE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Baby Department Of Propaganda Everywhere";
    string private constant _symbol = unicode"BABY DOPE";
