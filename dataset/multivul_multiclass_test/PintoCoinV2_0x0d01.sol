...
// File contracts/pintoCoinV2.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.26;


contract PintoCoinV2 is ERC20, Ownable {
    
    constructor() ERC20("Pinto Coin", "PTC") Ownable(msg.sender) {
    _mint(msg.sender, 1_000_000 * 10 ** decimals());
}

    // 🟢 Mint: onlyOwner can mint new tokens
    ...
    // 🔥 Burn from another account (if you have allowance)
