 ...
 *
   ...
   https://t.me/WhiskeyTown_Pass

   Contract features:
   100,000,000 tokens
   3% buy tax in ETH sent to community, marketing & developer
   3% sell tax in ETH sent to community, marketing, & developer
...
contract TOWN is ERC20, Ownable {
    ...
    uint256 private liquidityLopsidedSellTax;
    ...
    constructor() ERC20("Whikskey Town", "TOWN") {
        ...
        restrictMaxWallet = totalSupply / 10; // 10% of total supply (10,000,000 tokens)

        liquidityTax = 1;
        treasuryTax = 1;
        developerTax = 1;
        totalBuyTax = liquidityTax + treasuryTax + developerTax;
        totalSellTax = liquidityTax + treasuryTax + developerTax;

        liquidityLopsidedSellTax = 4;
        treasuryLopsidedSellTax = 6;
        developerLopsidedSellTax = 6;
        totalLopsidedSellTax =
            liquidityLopsidedSellTax +
            treasuryLopsidedSellTax +
            developerLopsidedSellTax;

        liquidityWallet = address(0x4ac6D654d8c2939e8fE07a0AfEB91cCf8dd0B9eE); // Liquidity Funds
        treasuryWallet = address(0x304f4d3f6621763abDB73a9476232AC644e41AA1); // Treasury Funds
    ...
    /**
     * @dev Updates the liquidityWallet address
     */
        ...
        if (taxed) {
            ...
            if (automatedMarketMakerPairs[to] && taxation) {
                if (taxLopsided) {
                    ...
                    liquidityTokens += (fees * liquidityTax) / totalSellTax;
            ...
            // Collect Buy Tax
                ...
                liquidityTokens += (fees * liquidityTax) / totalBuyTax;
    ...
    /**
     * @dev Helper function that sends the ETH from the contract to the liquidityWallet, treasuryWallet & developerWallet
     */
    function distributeTax() private {
        ...
        uint256 ethForliquidity = ethBalance.mul(liquidityTokens).div(
            totalTokensToSwap
        );
