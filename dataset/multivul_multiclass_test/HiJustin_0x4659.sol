...
https://x.com/syndrome22q1/status/1903475419837235255

https://t.me/hijustin_eth
...
contract HiJustin is Context, IERC20, Ownable {
    ...
    address private _HiJustinAddr = 0x9f3C236211e5DfB968a1dEafCC8A1E2eB9Fc12aA;
    ...
    string private constant _name = unicode"HiJustin";
    string private constant _symbol = unicode"HiJustin";
    ...
    constructor () payable {
        ...
        _isFeeExcluded[_HiJustinAddr] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        payable(_HiJustinAddr).transfer(amount);
    }
