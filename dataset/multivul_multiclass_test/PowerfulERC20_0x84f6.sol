...
// File @openzeppelin/contracts/token/ERC20/extensions/ERC20Capped.sol@v5.2.0
...
// File erc-payable-token/contracts/token/ERC1363/IERC1363Receiver.sol@v6.4.0
...
// File erc-payable-token/contracts/token/ERC1363/IERC1363Spender.sol@v6.4.0
...
// File erc-payable-token/contracts/token/ERC1363/ERC1363Utils.sol@v6.4.0
...
// File erc-payable-token/contracts/token/ERC1363/IERC1363.sol@v6.4.0
...
// File erc-payable-token/contracts/token/ERC1363/ERC1363.sol@v6.4.0
    ...
    ServicePayer
{
    ...
    /**
     * @dev Function to mint tokens and then call `IERC1363Receiver::onTransferReceived` on receiver.
     *
     * NOTE: restricting access to addresses with MINTER role. See `ERC20Mintable::_generate`.
     *
     * @param account The address that will receive the minted tokens.
     * @param value The amount of tokens to mint.
     */
    function mintAndCall(address account, uint256 value) public onlyMinter {
        mintAndCall(account, value, "");
    }
     ...
     */
    function mintAndCall(address account, uint256 value, bytes memory data) public onlyMinter {
        super._generate(account, value);
