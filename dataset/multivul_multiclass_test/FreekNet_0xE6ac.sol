...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "FREEK: decreased allowance below zero");
        unchecked {
    ...
    function _transfer(
        ...
        require(from != address(0), "FREEK: transfer from the zero address");
        require(to != address(0), "FREEK: transfer to the zero address");

        _beforeTokenTransfer(from, to, amount);

        uint256 fromBalance = _balances[from];
        require(fromBalance >= amount, "FREEK: transfer amount exceeds balance");
        unchecked {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0), "FREEK: mint to the zero address");
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        require(accountBalance >= amount, "FREEK: burn amount exceeds balance");
        unchecked {
    ...
    function _approve(
        ...
        require(owner != address(0), "FREEK: approve from the zero address");
        require(spender != address(0), "FREEK: approve to the zero address");
    ...
    function _spendAllowance(
        ...
        if (currentAllowance != type(uint256).max) {
            require(currentAllowance >= amount, "FREEK: insufficient allowance");
            unchecked {
...
contract FreekNet is ERC20, Ownable {
    ...
    string private constant _name = unicode"Freek Net";
    string private constant _symbol = unicode"FRNT";
    ...
    function setAutomatedMarketMakerPairFREEK(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "FREEK: The pair cannot be removed from automatedMarketMakerPairs");
