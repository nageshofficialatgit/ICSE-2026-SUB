...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function transferFrom(
        ...
        require(
            ...
            "EUPH: transfer amount exceeds allowance"
        );
        unchecked {
    ...
    function decreaseAllowance(
        ...
        require(
            ...
            "EUPH: decreased allowance below zero"
        );
        unchecked {
    ...
    function _transfer(
        ...
        require(sender != address(0), "EUPH: transfer from the zero address");
        require(recipient != address(0), "EUPH: transfer to the zero address");
        ...
        require(
            ...
            "EUPH: transfer amount exceeds balance"
        );
        unchecked {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0), "EUPH: mint to the zero address");
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(account != address(0), "EUPH: burn from the zero address");

        _beforeTokenTransfer(account, address(0), amount);

        uint256 accountBalance = _balances[account];
        require(accountBalance >= amount, "EUPH: burn amount exceeds balance");
        unchecked {
    ...
    function _approve(
        ...
        require(owner != address(0), "EUPH: approve from the zero address");
        require(spender != address(0), "EUPH: approve to the zero address");
...
contract EuphoriaContract is ERC20, Ownable {
    ...
    constructor() ERC20("Euphoria", "EUPH") {
        ...
        marketingWallet = address(0x804885f6bfE5CDC7969Fd44E181Cf263a90fBFf7);
     ...
     */
    function view_address_permissions_EUPH(
        address _target
    )
        external
        view
    ...
    function _transfer(
        ...
        require(from != address(0), "EUPH: transfer from the zero address");
        require(to != address(0), "EUPH: transfer to the zero address");
