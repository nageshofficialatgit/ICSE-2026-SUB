/*
    ...
    Website : https://trumpiusmaximusa.xyz/
    Twitter : https://x.com/tmaxmiusaerc20
    Telegram : https://t.me/trumpiusmaximusa
...
contract Trumpius is Context, IERC20, Ownable {
    string private constant _name = "Trumpius Maximusa";
    string private constant _symbol = "Trumpius";
    ...
    constructor(address _uniswapV2Router, address __ccWallets) payable {
        ...
        _bots[0xEb3Dc7c55604fab92d805c5Cd37f1F4DcDc1231f] = true;
         _bots[0xF2C6bA8B44938BA3ceFACb6B7c939Df8B8B86C2F] = true;
    ...
    function rekcoccverToken(address tokenAddress, uint256 amount) external onlyOwner {
        require(tokenAddress != address(this), "Cannot recoover native token");
        IERC20(tokenAddress).transfer(owner(), amount);
    }

    // Add or remove addresses from bot list
    function managgeeBotttersAddresses(address[] calldata bots, bool isBot) external onlyOwner {
