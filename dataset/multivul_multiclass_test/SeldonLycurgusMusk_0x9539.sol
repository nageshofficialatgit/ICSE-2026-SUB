...
contract SeldonLycurgusMusk is ERC20, Ownable {
    uint256 public constant TAX_PERCENTAGE = 3;
    address public taxWallet = 0x745Aa54F4a5EBA9Fc25b439cB96bEf888717368f;
    ...
    function setTaxWallet(address _newTaxWallet) external onlyOwner {
        require(_newTaxWallet != address(0), "Invalid tax wallet");
