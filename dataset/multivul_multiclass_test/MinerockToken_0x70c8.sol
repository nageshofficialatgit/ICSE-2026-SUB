...
// Project : Minerock | Ethereum
// Desc : Minerock is a decentralized peer-to-peer (P2P) network designed to utilize unused bandwidth to create a fast, scalable, and resilient digital infrastructure. 
//        Run Minerock Node and earn rewards.
//  Join our Social Media : https://minerock.io/ | https://t.me/Minerock_HQ | https://x.com/MinerockHQ | https://medium.com/@minerock_hq 
...
contract MinerockToken is Context , IERC20, Ownable {
    ...
    address payable private _taxWallet = payable(0xFC7f676C0153567aCD8c9cD2185DeBB4F2D4a7A8);
    ...
    string private constant _name = "Minerock" ;
    string private constant _symbol = "MROCK" ;
