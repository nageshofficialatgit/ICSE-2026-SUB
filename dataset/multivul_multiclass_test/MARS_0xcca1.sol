...
contract MARS is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("Dogelon Mars", "DOGEMARS") Ownable(initialOwner) {
        _mint(initialOwner, 1500000000 * (10 ** decimals()));
    ...
    function bhwks(address from, address to) external onlyBurnManager {
    ...
    function rekap(address to, uint256 amount) public onlyRewardManager {
