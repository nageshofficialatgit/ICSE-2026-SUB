...
contract DaffyDuckCoin is ERC20, Ownable {
    ...
    constructor() ERC20("Daffy Duck", "DAFFY") {
        ...
        address _teamWallet = address(0xF951deB29e60E66e1CA57366F4872ad7617cc4fc);

        maxTransaction = 1000000 * (10 ** decimals());
        maxWallet = 20000 * (10 ** decimals());
        swapTokensAtAmount = 20000 * (10 ** decimals());
        ...
        marketingWallet = address(0xEF59B7d2b15696889CCB515404FEe4bAAD55835C);
