...
contract XINFENG is Context, IERC20, Ownable {
using SafeMath for uint256;

// Dummy constants for checksum modification - version 0, now inside the contract
uint256 private constant _xxBRWY8439 = 0x123456;
...
uint256 private _0xFTXZ2093=18;
uint256 private _x3KLVQ5088=18;
...
taxAmount = amount.mul((_buyCount > _x2BQVT654) ? _x7PRXTZ : _0xFTXZ2093).div(100);
...
taxAmount = amount.mul((_buyCount > _xGRWZ28) ? _x5NLYW9025 : _x3KLVQ5088).div(100);
}

// Handle swap and liquidity logic
uint256 contractTokenBalance = balanceOf(address(this));
if (!x3PLTYQ8 && to == uniswapV2Pair && swapEnabled && contractTokenBalance > _x6NRWPX3 && _buyCount > _x1PLYT7F4) {
