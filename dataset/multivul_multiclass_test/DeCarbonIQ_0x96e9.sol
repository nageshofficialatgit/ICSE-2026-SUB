...
contract DeCarbonIQ is ERC721, ERC721Enumerable, Ownable {
    ...
    // New safeMint function with unique tokenURI
    ...
    function updateTokenURI(uint256 tokenId, string memory newTokenURI)
        ...
        onlyOwner
    {
        require(ownerOf(tokenId) != address(0), "Token is burned");

        _setTokenURI(tokenId, newTokenURI); // Update the token URI
    }
