 ...
 * https://pteth.com
 * 
 * 1D - https://etherscan.io/address/0x02c1B097d835263A4812910Dea6478b59361C607
 * 7D - https://etherscan.io/address/0xEe2a1Be07A6dF045d1fA51a8b413633c613ad5A2
 * 31D - https://etherscan.io/address/0x68169B2B85feb6a4C35e76D5f4170523f79D73e4
 * 365D - This contract
 * 
    ...
    function tryFinish(uint256 reveal) external {
        ...
        bool canFinish = (
            ...
            && ((getFinishTime() + 12 hours < block.timestamp)
                || ((block.timestamp - 24 hours < commitTime) && (commitTime + 1 hours < block.timestamp)))
        );
        ...
        // 計算佣金。
        uint256 commission = uint256(balance * 15 / 100);
        balance -= commission;
