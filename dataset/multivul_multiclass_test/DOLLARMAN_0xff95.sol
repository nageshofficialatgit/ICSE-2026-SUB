/*
An experiment in decentralized finance. I am down to my last dollar. I donate it to you, the ETH community. 

1% max tx and wallet. 15/15 taxes will all be manually added to liquidity. Removal of taxes and contract renounce when burned liquidity ratio is acceptable. Let's see who is left in the ETH trenches. 

SAFETY: 
1) ANTI HONEYPOT: hardcoded taxes, cannot ever be > 15 for buy and sell.
2) $1 starting liquidity, burned at launch. 
*/
...
contract DOLLARMAN is ERC20, Ownable {
    ...
    constructor() ERC20("My Last Dollar", "DOLLA") {
        ...
        uint256 _buyProjectTax = 15;

        uint256 _sellMarketingTax = 0;
        uint256 _sellProjectTax = 15;
        ...
        marketingWallet = address(0xE94c8724B1C7a36621766bb073396BeD0E51ed94);
    ...
    function setFeesBuy(
        ...
        buyTaxTotal = buyMarketingTax + buyProjectTax;
        require(buyTaxTotal <= 15, "Total buy fee cannot be higher than 15%");
    ...
    function setFeesSell(
        ...
        require(
            sellTaxTotal <= 15,
            "Total sell fee cannot be higher than 15%"
        );
