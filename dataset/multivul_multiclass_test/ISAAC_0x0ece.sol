...
contract ISAAC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Isaac GR00T N1";
    string private constant _symbol = unicode"ISAAC";
