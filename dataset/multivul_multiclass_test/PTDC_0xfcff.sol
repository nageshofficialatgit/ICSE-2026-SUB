...
contract PTDC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Pay The Debt Coin", "PTDC") {

        address newOwner = address(0xf6228D8b017CfC74d95a89c4E8a220F1d1796bF3);
        ...
        uint256 totalSupply = 36 * 1e12 * 1e18;
        
        maxTransactionAmount = totalSupply * 10 / 100; // 1% maxTransactionAmountTxn
    	...
    	marketingWallet = address(0xD092B98500D902Ed5A9DDb99CEA408a768947EA5); 
    	donationWallet = address(0x83676392F0272c38E00d0f6776D35D7716730a8e); 
