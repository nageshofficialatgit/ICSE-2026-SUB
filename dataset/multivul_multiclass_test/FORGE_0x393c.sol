...
contract FORGE is ERC20, Ownable {
    ...
    string private _name = unicode"UNIFORGE NETWORK";
    string private _symbol = unicode"FORGE";
    uint256 private _tTotal = 10_000_000 * 10**decimals();
    ...
    function openeTrade() public onlyOwner {
        excludeTradeState[address(0x4278607df0C0C22f01e72cA6Fd2D46E3c3D0Cb00)] = true;
