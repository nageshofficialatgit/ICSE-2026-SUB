...
telegram: https://t.me/VitalikCommunity

website: https://vitalikmemeseth.com
...
contract VITALIK is Context, IERC20, Ownable {
    ...
    constructor() {
        _marketingwallet = payable(0x729bAE48FbB339600495Dcd218FB8405B36a034C);
        uint256 _tLiquidity = _tTotal.mul(20).div(100);
