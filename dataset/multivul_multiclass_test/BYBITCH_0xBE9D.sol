...
contract BYBITCH is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Bybitch";
    string private constant _symbol = unicode"BYBITCH";
