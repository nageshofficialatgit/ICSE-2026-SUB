...
Name: Giko Cat
Ticker: GIKOCAT
My name is Giko Cat n im the 1st cat on the intrnt!! >.<

Website: https://gikocatoneth.lol
X: https://x.com/gikocat_erc20
Telegram: https://t.me/gikocat_portal
...
contract GIKOCAT is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"GIKOCAT";
    ...
    constructor() payable {
        _taxWallet = payable(0x16107C18c7ED1c59436ff3B472116Dfb1fa8756d);
