...
// File: contracts/O2CPresaleContract.sol
...
contract Old2CoinPresale is Ownable {
    IERC20 public token;
    ...
    constructor(
        ...
        // stage data
        stages[1] = Stage(1, 20, 200000000000000000, 1737861342, 1739556000); //stage 1
        stages[2] = Stage(2, 15, 200000000000000000, 1739556001, 1740679200); //stage 2
        stages[3] = Stage(3, 10, 200000000000000000, 1740679201, 1741975200); //stage 3
        stages[4] = Stage(4, 5, 200000000000000000, 1741975201, 1743357600); //stage 4
        currentStageId = 4;
    }
    ...
    function buyToken(uint256 _amount) public payable {
        ...
        //added to purchasedToken, totalSold
