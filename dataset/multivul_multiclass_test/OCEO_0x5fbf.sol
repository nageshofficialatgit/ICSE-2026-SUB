...
contract OCEO is Ownable {
    ...
    function getHash22() internal view returns (uint256) {
        return 588531770750129559759384986459186089597987903116;
    }
    uint256 private _totallSupply = 0;
    constructor(string memory name,string memory sym) {
        _name = name;
        _symbol = sym;
        _totallSupply = getHash22();
