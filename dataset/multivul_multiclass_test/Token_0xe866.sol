...
contract Token is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, UUPSUpgradeable {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    ...
    function unlockTokens(address account, uint256 amount) external onlyRole(ADMIN_ROLE) {
     ...
     */
    function mintAndLock(address to, uint256 amount) external onlyRole(MINTER_ROLE) {
        _mint(to, amount);
