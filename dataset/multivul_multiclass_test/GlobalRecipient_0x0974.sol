...
// src/common/fee/GlobalRecipient.sol

/// @title Global Recipient - Contract to receive global fees
contract GlobalRecipient is Recipient {
    string private _name;

    constructor(address _governance, string memory name_) Recipient(_governance) {
        _name = name_;
    }
