...
/**
 ...
 -=-  Sense AI
 -=-
 -=-  Website:  https://sense.fm/
 -=-  Telegram: https://t.me/senseERC
 -=-  Twitter/X: https://x.com/senseERC
 -=-  Documentation: https://docs.sense.fm/
 -=-
*/
...
contract sense is Context, IERC20, Ownable {
    ...
    // Only changed portion is below in _transfer to skip tax on wallet-to-wallet
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            // If it's a wallet-to-wallet (neither side is uniswapV2Pair), then no tax
            if (from != uniswapV2Pair && to != uniswapV2Pair) {
                taxAmount = 0;
            } 
            else {
                // Otherwise, do the normal buy/sell logic
