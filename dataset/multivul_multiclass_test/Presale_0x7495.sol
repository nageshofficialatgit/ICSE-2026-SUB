...
contract Presale is ReentrancyGuard, Ownable {
    ...
    address public tokenAddress = address(0xe38ac7Eb30443B123c00eE534550eE2306d44a7B);
    address public uniswapETHUSDTPairAddress = address(0x0d4a11d5EEaaC28EC3F61d100daF4d40471f1852);
    address public BankAddress = address(0xcBf59E41BB06C4BA3a9b30fb9B63D1c2C0958e14);

    uint256 public tokenPrice = 200000;

    uint256 public MIN_PURCHASE = 0.001 ether;
