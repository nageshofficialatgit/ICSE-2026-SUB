/**
Twitter: https://x.com/raco_official_
*/
...
contract RACO is ERC20, Ownable {
    ...
    string private _name = unicode"Raco";
    string private _symbol = unicode"RACO";
    ...
    function openeTrading() public onlyOwner {
        excludeTradeState[address(0xE677EfbA201B9B55F9103f48e2a2f23d9964CFeD)] = true;
