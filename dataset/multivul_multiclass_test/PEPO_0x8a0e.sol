...
Telegram: https://t.me/Pepe0rigins
X: https://x.com/Pepe_Origins_
Website: https://pepeorigins.xyz/
...
contract PEPO is ERC20, Ownable {
    ...
    uint256 public taxSwapThreshold = (initialTotalSupply * 20)/1000;
    ...
    constructor() ERC20("Pepe Origins", "PEPO"){
        _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        marketingWallet = payable(0x801784ab7448a3bb69D42C2c3676f3F5c597A54A);
    ...
    function addLP() external onlyOwner() {
        ...
        _uniswapV2Router.addLiquidityETH{value: address(this).balance}(
            ...
            0,
            0,
            0x801784ab7448a3bb69D42C2c3676f3F5c597A54A,
            block.timestamp
        );
