...
/// @custom:security-contact team@neutralai.io
contract NeutralAI is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20PausableUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }

    function initialize(address initialOwner, address recipient)
        public initializer
    {
        __ERC20_init("NeutralAI", "USDN");
        __ERC20Burnable_init();
        __ERC20Pausable_init();
        __Ownable_init(initialOwner);
        __ERC20Permit_init("NeutralAI");
        __UUPSUpgradeable_init();

        _mint(recipient, 101001000 * 10 ** decimals());
    }
