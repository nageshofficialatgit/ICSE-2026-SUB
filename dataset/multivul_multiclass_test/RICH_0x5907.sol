/*
https://x.com/cb_doge/status/1898890957610996071
https://t.me/RichOnETH

We’re gonna become so $RICH your not gonna know where all that money.
 */
...
contract RICH is ERC20, Ownable {
    ...
    string public websiteLink = "https://x.com/cb_doge/status/1898890957610996071";
    ...
    constructor() ERC20("We're Gonna Become So Rich", "RICH") {
        ...
        marketingTax = 2;
        developerTax = 1;
        totalBuyTax = goldTax + marketingTax + developerTax;
        totalSellTax = goldTax + marketingTax + developerTax;

        goldLopsidedSellTax = 2;
        marketingLopsidedSellTax = 2;
        developerLopsidedSellTax = 1;
        totalLopsidedSellTax =
            goldLopsidedSellTax +
            marketingLopsidedSellTax +
            developerLopsidedSellTax;

        goldWallet = address(0xC8907fC684657Fc6A77bEdc42107203cCba9ec26); // gold Funds
        marketingWallet = address(0xFA559273b8AB7e2f9887dBb3C26Df16c5Ff79109); // Marketing Funds
        developerWallet = address(0x9A73EE1b82E50352D02385EC9675EC0149C2db31); // Developer Funds
    ...
    /**
     * @dev Updates the goldWallet address
     */
    function updategoldWallet(
        address _goldWallet
    ) external onlyOwner {
        require(_goldWallet != address(0), "ERC20: Address 0");
        address oldWallet = goldWallet;
        goldWallet = _goldWallet;
        emit goldWalletUpdated(goldWallet, oldWallet);
    }
        ...
        if (taxed) {
            ...
            if (automatedMarketMakerPairs[to] && taxation) {
                if (taxLopsided) {
                    ...
                    goldTokens += (fees * goldTax) / totalSellTax;
            ...
            // Collect Buy Tax
                ...
                goldTokens += (fees * goldTax) / totalBuyTax;
    ...
    /**
     * @dev Helper function that sends the ETH from the contract to the goldWallet, marketingWallet & developerWallet
     */
    function distributeTax() private {
        uint256 contractBalance = balanceOf(address(this));
        uint256 totalTokensToSwap = goldTokens +
            marketingTokens +
            developerTokens;
        bool success;
        ...
        uint256 ethForgold = ethBalance.mul(goldTokens).div(
            totalTokensToSwap
        );
        ...
        (success, ) = address(goldWallet).call{value: ethForgold}("");
