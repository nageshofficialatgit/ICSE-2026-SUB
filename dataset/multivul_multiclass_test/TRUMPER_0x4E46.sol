...
Website: https://trumper-eth.live
Telegram: https://t.me/trumper_erc
Twitter: https://x.com/trumper_erc
...
contract TRUMPER is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Trumper";
    string private constant _symbol = unicode"TRUMPER";
    ...
    constructor() payable {
        _taxWallet = payable(0xD908422302Aa465050f360C04B37767858224C9C);
