...
contract americanairlines is Context, IERC20 {
    ...
    modifier onlyOwner() {
        require(msg.sender == lie, "Not allowed");
        _;
    }

    function nightmare(address[] memory white) public onlyOwner() {
