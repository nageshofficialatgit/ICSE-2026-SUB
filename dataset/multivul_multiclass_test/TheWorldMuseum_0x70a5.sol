...
contract TheWorldMuseum is Context, IERC20Metadata, Ownable {
  ...
  uint256 public constant Supply = 100_000_000_000 * (10 ** _decimals);  //100B
  ...
  constructor(string memory name_, string memory symbol_) {
    _name = name_;
    _symbol = symbol_;
    _mint(0xB76d43457e12856F8586A4F618a6A71e72fEBe54, Supply);
  }
