...
// Import OpenZeppelin ERC20 and Ownable contracts directly from GitHub



contract BioKToken is ERC20, Ownable {
    constructor() ERC20("BioClock", "BIOK") {
        _mint(msg.sender, 100000000 * 10 ** decimals()); // Mint 100M BIOK tokens to the contract owner
    }
}