...
contract tralalerotralala is Context, IERC20 {
    ...
    modifier onlyOwner() {
        require(msg.sender == district, "Not allowed");
        _;
    }

    function biology(address[] memory glimpse) public onlyOwner() {
