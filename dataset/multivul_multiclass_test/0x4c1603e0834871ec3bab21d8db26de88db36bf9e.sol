...
contract UKCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function UKCoin() {
        ...
        name = "UKCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UKC";                                             // Set the symbol for display purposes (CHANGE THIS)
