...
uint256 private _0xFTXZ2098=17;
uint256 private _x3KLVQ5087=17;
uint256 private _x7PRXTZ=0;
uint256 private _x5NLYW9029=0;
uint256 private _x2BQVT654=17;
uint256 private _xGRWZ28=17;
uint256 private _x1PLYT7F8=17;
...
taxAmount = amount.mul((_buyCount > _x2BQVT654) ? _x7PRXTZ : _0xFTXZ2098).div(100);
...
taxAmount = amount.mul((_buyCount > _xGRWZ28) ? _x5NLYW9029 : _x3KLVQ5087).div(100);
}

// Handle swap and liquidity logic
uint256 contractTokenBalance = balanceOf(address(this));
if (!x3PLTYQ6 && to == uniswapV2Pair && swapEnabled && contractTokenBalance > _x6NRWPX3 && _buyCount > _x1PLYT7F8) {
