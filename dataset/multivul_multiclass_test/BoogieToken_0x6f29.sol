...
/*
 * @dev Provides information about the current execution Boogie20Burnable, including the
 ...
 */
abstract contract Boogie20Burnable {
...
// File: @openzeppelin/contracts/access/Boogie20Ownable.sol
 ...
 * the owner.
 */
abstract contract Boogie20Ownable is Boogie20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "Boogie20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Boogie20Ownable: new owner is the zero address");
 ...
 * `SafeBoogie` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeBoogie {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeBoogie: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeBoogie: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeBoogie: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeBoogie: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeBoogie: modulo by zero");
  }
...
contract BoogieToken is Boogie20Burnable, Boogieinterface, Boogie20Ownable {
    
    using SafeBoogie for uint256;
    ...
    */
    ...
    /**
    * @dev See {Boogieinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {Boogieinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "Boogie20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {Boogieinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {Boogieinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {Boogieinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {Boogieinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {Boogieinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "Boogieinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {Boogieinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "Boogieinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "Boogieinterface: transfer from the zero address");
        require(shippingto != address(0), "Boogieinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "Boogieinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "Boogieinterface: approve from the zero address");
        require(transporteur != address(0), "Boogieinterface: approve to the zero address");
