...
/*
 * @dev Provides information about the current execution STARSdog20Burnable, including the
 ...
 */
abstract contract STARSdog20Burnable {
...
// File: @openzeppelin/contracts/access/STARSdog20Ownable.sol
 ...
 * the owner.
 */
abstract contract STARSdog20Ownable is STARSdog20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "STARSdog20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "STARSdog20Ownable: new owner is the zero address");
 ...
 * `SafeSTARSdog` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeSTARSdog {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeSTARSdog: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeSTARSdog: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeSTARSdog: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeSTARSdog: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeSTARSdog: modulo by zero");
  }
...
contract STARSdogToken is STARSdog20Burnable, STARSdoginterface, STARSdog20Ownable {
    
    using SafeSTARSdog for uint256;
    ...
    */
    ...
    /**
    * @dev See {STARSdoginterface-totalSupply}.
    */
    ...
    /**
    * @dev See {STARSdoginterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "STARSdog20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {STARSdoginterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {STARSdoginterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {STARSdoginterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {STARSdoginterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {STARSdoginterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "STARSdoginterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {STARSdoginterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "STARSdoginterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "STARSdoginterface: transfer from the zero address");
        require(shippingto != address(0), "STARSdoginterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "STARSdoginterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "STARSdoginterface: approve from the zero address");
        require(transporteur != address(0), "STARSdoginterface: approve to the zero address");
