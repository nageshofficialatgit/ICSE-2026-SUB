...
// File: contracts/artifakt_voucher_v2.sol
...
contract ArtifaktVoucher is ERC1155, Ownable, ERC1155Burnable {

    // v2
    string public salt = "21";

    string public name = "Artifakt Voucher";
    string public symbol = "ARTIFAKT";
    string public baseUri = "https://artifakt.tech/json/nft/voucher/{id}.json";

    //ERC20 payment token contract
    ...
    function mintErc20(
        ...
        //the ERC1155 tokenId is the amount 

        //amount is in wei
        takeAndSplitErc20(amount);

        //receiver, tokenId, qty, data
