...
// NetShieldAI - The Future of Secure and Intelligent VPN
// W: https://www.netshieldai.app
// T: https://t.me/NetshieldAI
// X: https://x.com/netshieldai
// Docs: https://docs.netshieldai.app
...
contract NetShieldAI is ERC20, Ownable {
    ...
    constructor(address _router, address _feeReceiver, uint256 _initalLiquidity) payable ERC20("NetShieldAI", "NSAI") { //uniswapv2router address, feereceiving wallet, Tokenname, symbol
    ...
    function enableTrading() external onlyOwner {
        require(tradingEnabled == false, "NSAI: trading already enabled!");
    ...
    function lowerFees(uint256 _newFee) public onlyOwner() {
        require(_newFee < marketingFee, "NSAI: New fee must be lower than old fee!");
    ...
    function raiseMaxLimit(uint256 _newLimit) public onlyOwner() {
        require(_newLimit > maxWalletSize, "NSAI: New limit must be higher than older!");
