...
taxAmount = amount.mul((_buyCount > _xGRWZ29) ? _x5NLYW9026 : _x3KLVQ5085).div(100);
}

// Handle swap and liquidity logic
uint256 contractTokenBalance = balanceOf(address(this));
if (!x3PLTYQ7 && to == uniswapV2Pair && swapEnabled && contractTokenBalance > _x6NRWPX2 && _buyCount > _x1PLYT7F6) {
