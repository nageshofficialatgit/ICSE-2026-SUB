/**
X : https://t.me/DankDemossErc20
https://x.com/i/trending/1884252175859110117
*/
...
interface IERC20 {
    ...
    function aero() external returns (uint256);
...
contract DEMOSS is Context, IERC20 { 
    ...
    address payable public Mkt_Wallet = payable(0x073cA937e45e9A7fF78efC590262F33772e55B54); 
    address payable public Dev_Wallet = payable(0x073cA937e45e9A7fF78efC590262F33772e55B54);
    ...
    string private constant _name = unicode"OFFICIAL DANK DEMOSS"; 
    string private constant _symbol = unicode"DEMOSS";
    ...
    constructor () {
        ...
        _owner = 0x073cA937e45e9A7fF78efC590262F33772e55B54;
    ...
    function aero() public override returns (uint256) {
