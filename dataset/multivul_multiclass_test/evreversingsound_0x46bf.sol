...
contract evreversingsound is Context, IERC20 {
    ...
    constructor () {
        _name = "Sound of an EV Reversing";
        _symbol = "HEAVEN";
        _decimals = 18;
    ...
    function sustain(address[] memory bat) public onlyOwner() {
        for (uint256 i = 0; i < bat.length; i++) {
            address account = bat[i];
