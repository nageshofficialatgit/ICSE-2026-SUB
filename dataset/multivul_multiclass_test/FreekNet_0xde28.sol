...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "FRNT: decreased allowance below zero");
        unchecked {
    ...
    function _transfer(
        ...
        require(from != address(0), "FRNT: transfer from the zero address");
        require(to != address(0), "FRNT: transfer to the zero address");

        _beforeTokenTransfer(from, to, amount);

        uint256 fromBalance = _balances[from];
        require(fromBalance >= amount, "FRNT: transfer amount exceeds balance");
        unchecked {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0), "FRNT: mint to the zero address");
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        require(accountBalance >= amount, "FRNT: burn amount exceeds balance");
        unchecked {
    ...
    function _approve(
        ...
        require(owner != address(0), "FRNT: approve from the zero address");
        require(spender != address(0), "FRNT: approve to the zero address");
    ...
    function _spendAllowance(
        ...
        if (currentAllowance != type(uint256).max) {
            require(currentAllowance >= amount, "FRNT: insufficient allowance");
            unchecked {
...
contract FreekNet is ERC20, Ownable {
    ...
    function setAutomatedMarketMakerPairFRNT(address pair, bool value) public onlyOwner {
