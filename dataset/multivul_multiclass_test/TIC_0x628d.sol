...
Name: Tree in Cat
Ticker: TIC
The absurd OG animals-plant Memeverse

Website: https://www.treeincatoneth.site
X: https://x.com/treeincat_erc20
Telegram: https://t.me/treeincat_eth
...
contract TIC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Tree in Cat";
    string private constant _symbol = unicode"TIC";
    ...
    constructor() payable {
        _taxWallet = payable(0x2a97a3537bd689cf6BEDe16dAdC1811297A48ea0);
