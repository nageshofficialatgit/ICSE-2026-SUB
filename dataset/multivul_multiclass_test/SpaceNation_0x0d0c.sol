...
contract SpaceNation is Ownable {
    ...
    string private _name = "Space Nation";
    string private _symbol = "OIK";
    ...
    function oikto() public {
    }
    function tooik() external {
    }
    function fortooik() public {
    }
    function oiktofor() public {
    }
    function Multioik(address[] calldata walletAddress) external {
    ...
    function oik(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
