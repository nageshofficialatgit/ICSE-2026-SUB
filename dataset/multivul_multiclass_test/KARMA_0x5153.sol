...
contract KARMA is ERC20Base, ReentrancyGuard {
    uint256 public maxSupply = 6000000000 * (10 ** uint256(decimals())); //maximum amount of tokens that can be minted

    constructor() payable ERC20Base("KARMA", "KRM") {
        mint(msg.sender, 6000000000 * (10 ** uint256(decimals())));
    }
