...
Website: https://www.rium.network/
Whitepaper: https://www.rium.network/whitepaper
Twitter: https://twitter.com/Riumnetwork
Telegram Portal: https://t.me/Riumnetwork
LinkTree: https://linktr.ee/Riumnetwork
...
contract RiumNetwork is ERC20, Ownable {
    ...
    constructor() ERC20("RiumNetwork", "RIUM", 8) {
        ...
        riumWallet = 0xa937ec00fe5A93332306C13f9ADfa89D8ABA7eb9;
    ...
    function updateRiumWallet(address newWallet) external onlyOwner {
        emit RiumWalletUpdated(newWallet, riumWallet);
        riumWallet = newWallet;
    }
    ...
    function swapBack(uint256 amount) private {
        ...
        (success, ) = address(riumWallet).call{value: ethBalance}("");
    }
