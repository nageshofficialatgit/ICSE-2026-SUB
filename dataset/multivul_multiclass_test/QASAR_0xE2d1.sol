...
contract QASAR is Context, IERC20, Ownable {
    using SafeMath for uint256;

    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee;
    address payable public _taxWallet = payable(0x936308CCC6c4DC6BEa6F37418f7aFcAA2Da8Fc14);
    ...
    string private constant _name = unicode"QASAR";  // Name
    string private constant _symbol = unicode"QASAR"; // Symbol
    ...
    function includeInFeeQASAR(address account) public onlyOwner {
