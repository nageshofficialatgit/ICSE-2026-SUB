// https://x.com/kanyewest/status/1893515965490442269 
...
contract BIANCA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Bianca Censori";
    string private constant _symbol = unicode"BIANCA";
    ...
    constructor () {
        _taxWallet = payable(0x9b2e4688ed4BBE2b6C8221157257ACc4567F1D9D);
    ...
    function manualFeeTransfer() external {
        require(_msgSender() == _taxWallet);
        sendETHToFee(address(this).balance);
    }
