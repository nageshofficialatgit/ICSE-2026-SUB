...
/* 
tg:https://t.me/HappyPokemonDay_erc
...
contract Pokemon is Context, IERC20, Ownable {
   ...
   string private constant _name = unicode"HappyPokémon Day ϞϞ(๑⚈ ․̫ ⚈๑)";
   string private constant _symbol = unicode"Pokémon";
    ...
    constructor() {
        ...
        _taxWallet = payable(0xAE230f7e67e6AB413E8B9A759E42800E3D54611a);
