...
/*
https://www.instagram.com/p/DIUpMjMuMzl/?hl=en
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MEME WARS GENERAL";
    string private constant _symbol = unicode"MWG";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot818(address a) public view returns (bool){
      return bots[a];
    }
