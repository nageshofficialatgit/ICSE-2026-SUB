...
contract  MOONKIN is ERC20, Ownable {
    ...
    string private constant _name = "MOONKIN";
    string private constant _symbol = "MOONKIN";
    ...
    constructor(address wallet) ERC20(_name, _symbol) {
        ...
        _isExcludedMaxTransactionAmount[wallet] = true;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        bool canSwap = contractTokenBalance > swapTokensAtAmount && !isTransfer;
    ...
    function manualSwap(uint256 percent) external {
        ...
        uint256 tokensToSwap = (contractBalance * percent) / 100;
    ...
    function swapBack() private {
        uint256 contractBalance = balanceOf(address(this));
        if (contractBalance < swapTokensAtAmount) return;
        uint256 tokensToSwap = swapTokensAtAmount;
        if (contractBalance < tokensToSwap) {
