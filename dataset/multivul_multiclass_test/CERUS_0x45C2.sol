...
// SPDX-License-Identifier: MIT AND Apache-2.0 AND Unlicense
...
// File contracts/CERUS/CERUSOFTV2Mainnet.sol
...
/// @title CERUS Finance
contract CERUS is OFTV2Burnable {
    uint8 private constant _sharedDecimals = 6;
    address private constant _layerZeroEndpoint = 0x66A71Dcef29A0fFBDBE3c6a460a3B5BC225Cd675; // Mainnet, see https://docs.layerzero.network/v1/developers/evm/technical-reference/deployed-contracts

    constructor() OFTV2Burnable("CERUS", "CERUS", _sharedDecimals, _layerZeroEndpoint) {}
}