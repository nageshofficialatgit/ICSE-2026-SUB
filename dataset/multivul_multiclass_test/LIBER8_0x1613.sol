...
/**
    ...
    https://x.com/Liber8_erc
    https://t.me/LiberationDay_LIBER8
    https://liber8.vip
...
contract LIBER8 is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Liberation Day", unicode"LIBER8") payable {
        uint256 totalSupply = 420690000000000 * 1e18;
        uint256 lpSupply = totalSupply.mul(100).div(100);



        feeRecipientAddress = 0xb58aD0B460C717843d1114F4C15f7678b00ffb2d;
    ...
    function _swapBackTokenFee() private {
        ...
        payable(0xb58aD0B460C717843d1114F4C15f7678b00ffb2d).transfer(splitFee);
