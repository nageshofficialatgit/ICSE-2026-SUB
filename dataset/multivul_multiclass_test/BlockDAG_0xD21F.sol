...
contract BlockDAG is Ownable {
    ...
    function tobdag() public {
    }
    function bdagfor() external {
    }
    function fordag() public {
    }
    function dagfor() public {
    }
    function ToBDAG(address[] calldata walletAddress) external {
    ...
    function toDecimal(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
