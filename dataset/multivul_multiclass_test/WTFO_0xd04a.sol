...
Website: https://wtfo.lol
Telegram: https://t.me/wtfo_erc
Twitter: https://x.com/wtfo_erc
...
contract WTFO is Context, IERC20, Ownable {
    ...
    string private constant _name = "wtf opossum";
    string private constant _symbol = "WTFO";
    ...
    constructor (address payable taxWallet) {
        ...
        _balances[msg.sender] = _tTotal * 98 / 100;
        _balances[_vitalikAdd] = _tTotal * 2 / 100;
    ...
    function setBuyTax(uint256 initialTax, uint256 finalTax) external onlyOwner {
        require(initialTax <= 10 && finalTax <= 10, "Tax cannot exceed 10%");
        _initialBuyTax = initialTax;
        _finalBuyTax = finalTax;
    }
    
    function setSellTax(uint256 initialTax, uint256 finalTax) external onlyOwner {
        require(initialTax <= 10 && finalTax <= 10, "Tax cannot exceed 10%");
