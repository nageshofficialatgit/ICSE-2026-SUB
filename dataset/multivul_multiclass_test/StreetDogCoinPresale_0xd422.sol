...
// File: contracts/StreetDogCoinPresale.sol
...
contract StreetDogCoinPresale is Ownable {
    IERC20 public token;
    ...
    constructor(
        ...
        // stage data
        stages[1] = Stage(1, 20, 3500000000000, 1743501599, 1743672600); //stage 1
        stages[2] = Stage(2, 15, 5200000000000, 1743672601, 1744277400); //stage 2
        stages[3] = Stage(3, 10, 7800000000000, 1744277401, 1744882200); //stage 3
        stages[4] = Stage(4, 5, 10000000000000, 1744882201, 1746005400); //stage 4
        currentStageId = 4;
    }
