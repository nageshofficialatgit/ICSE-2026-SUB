...
contract MekanToken is Context, IERC20Metadata, Ownable {
  ...
  uint256 public constant Supply = 100_000_000 * (10 ** _decimals);  //100,000,000
  ...
  constructor(string memory name_, string memory symbol_) {
    _name = name_;
    _symbol = symbol_;
    _mint(0xCF114e38fb407e4cE73749B97a5910c14501AFf3, Supply);
  }
