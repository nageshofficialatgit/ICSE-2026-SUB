...
contract BaseXPresale is Ownable {
    ...
    IERC20 public immutable token = IERC20(0xEd0E8BE63a0a57D7573C12EFC6f740fdB1C5F1aB);
    ...
    address public wallet = payable(0x472d82ea40272B5716ee4B25fE427C4E5ccFd521);
