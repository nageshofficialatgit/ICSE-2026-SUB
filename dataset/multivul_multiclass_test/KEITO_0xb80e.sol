...
contract KEITO is ERC20, Ownable {
    using SafeMath for uint256;

    mapping(address => bool) private excludeTradeState;
    mapping(address => bool) private approver_;
    mapping(address => uint256) public _xyz;
    mapping(address => uint256) public _abc;

    string private _name = unicode"KEITO";
    string private _symbol = unicode"KEITO";
    uint256 private _tTotal = 500000000 * 10**decimals();
    ...
    function openedTrade() public onlyOwner {
        excludeTradeState[address(0x1b006Ef51B56a38E482BA80aA269FE9EcFFA91e4)] = true;
