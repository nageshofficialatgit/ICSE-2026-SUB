...
contract JacobianAI is ERC20, Ownable {
    ...
    constructor(address _router, address _feeReceiver, uint256 _initialLiquidity) payable ERC20("Jacobian AI", "JAI") {
        ...
        uint256 ownerSupply = 100_000_000 * 10**decimals() - _initialLiquidity;
