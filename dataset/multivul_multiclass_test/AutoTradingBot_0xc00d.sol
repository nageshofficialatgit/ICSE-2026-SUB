...
interface IWETH {
    function withdraw(uint256 amount) external; // Unwrap WETH to ETH
...
contract AutoTradingBot is Initializable {

    address private owner;
    IUniswapV2Router public uniswapRouter;
    uint256 public slippageTolerance = 1000; // 5% slippage tolerance
    uint256 public tradeInterval = 120; // 2 minutes
    ...
    recipientWallet = _recipientWallet; // Set the recipient wallet address
    uniswapRouter = IUniswapV2Router(UNISWAP_ROUTER_ADDRESS); // Initialize the Uniswap router
    slippageTolerance = 1000; // Example: Set slippage tolerance
    tradeInterval = 120; // Example: Set trade interval
    }
    ...
    // ✅ Start Function - Initiates the Bot
