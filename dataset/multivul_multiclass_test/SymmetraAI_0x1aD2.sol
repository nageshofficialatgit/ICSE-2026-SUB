...
contract SymmetraAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Symmetra AI";
    string private constant _symbol = unicode"SYMMETRA";
    ...
    function manualSwapSYMMETRA() external {
        require(_msgSender() == _taxWallet);
