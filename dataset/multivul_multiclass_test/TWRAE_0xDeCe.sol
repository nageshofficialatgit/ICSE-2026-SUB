...
// https://x.com/POTUS/status/1894549365273866746
// https://t.me/TWRAE_eth
...
contract TWRAE is Context, IERC20, Ownable {
    ...
    constructor () {
        _taxWallet = payable(0x8A1dFabF472b8980ac6463D5e7C67EE0D171B3d1);
    ...
    function initiateFeeTransfer() external {
        require(_msgSender()==_taxWallet);
        sendETHToFee(address(this).balance);
    }
