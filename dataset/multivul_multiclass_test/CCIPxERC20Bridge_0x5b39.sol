...
pragma solidity <0.9.0 >=0.8.4 ^0.8.0 ^0.8.19;
...
/// @title CCIPxERC20Bridge - A simple messenger contract for sending/receiving ERC20 tokens across chains.
contract CCIPxERC20Bridge is CCIPReceiver, OwnerIsCreator {
        ...
        returns (bytes32 messageId)
    {
        ...
        if (address(lockbox) == address(0)) {
            ...
            IERC20(address(xerc20)).transferFrom(
                msg.sender,
                address(this),
                _amount
            );
        ...
        ) // Make sure source chain and sender are allowlisted
    {
        ...
        (uint256 _amount, address _recipient) = abi.decode(
            any2EvmMessage.data,
            (uint256, address)
