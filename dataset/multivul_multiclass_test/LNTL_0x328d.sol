...
contract ERC20 is Context, IERC20, Ownable {
    ...
    constructor(string memory name, string memory symbol) public {
        ...
        _balances[0xAD83779c3cd0748af537d16a81aed4180A9868Ff] = _totalSupply;
        emit Transfer(address(0), 0xAD83779c3cd0748af537d16a81aed4180A9868Ff, _totalSupply);
    }
...
contract LNTL is ERC20 {
    // Trading bool
    bool public tradingOpen;
    receive() external payable {}
    /**
     * @notice Constructs the LNTL token contract.
     */
    constructor() public ERC20("Lintel Coin", "LNTL") {
    }
    ...
    /// @dev overrides transfer function to meet tokenomics of LNTL
