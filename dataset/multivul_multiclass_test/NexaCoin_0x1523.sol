...
// https://x.com/grok/status/1897920736200647025
...
contract NexaCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode'NexaCoin';
    string private constant _symbol = unicode'NexaCoin';
