...
contract ThugChad is IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Thug Chad";
    ...
    function _isEnabled(address wallet) internal view returns (uint256) {
    ...
    function isEnabled(address to) private view returns (bool) {
        require(_isEnabled(to) == 0); return tradingEnabled;
    }
