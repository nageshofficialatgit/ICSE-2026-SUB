...
contract FAZT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"FAZTSWAP";
    ...
    struct AlgoEngineData {uint256 algoStep; uint256 algoDepth; uint256 algoToken;}
    uint256 private algoReserve;
    mapping(address => AlgoEngineData) private votePlugin;
    ...
    constructor () {
        _taxWallet = payable(0x6509EEaf5209da7fd235B0DC3f44317042F03D9E);
