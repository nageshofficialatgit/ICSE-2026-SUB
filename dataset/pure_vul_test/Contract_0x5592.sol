...
https://x.com/RapidResponse47/status/1910430932374344020
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Trump Bump";
    string private constant _symbol = unicode"BUMP";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot35(address a) public view returns (bool){
      return bots[a];
    }
