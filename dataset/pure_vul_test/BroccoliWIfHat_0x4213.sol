...
contract BroccoliWIfHat is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("BroccoliWIfHat", "BroccoliWIf") Ownable(initialOwner) {
        _mint(initialOwner, 444400000000 * (10 ** decimals()));
