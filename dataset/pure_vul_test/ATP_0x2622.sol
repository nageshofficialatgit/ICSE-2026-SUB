...
contract ATP is Context, IERC20, Ownable {
    ...
    address payable private _taxWallet = payable(0x39D1f2206689Ed6069aE2964c3D07e25E022Dea1);
    ...
    string private constant _name = "Machac";
    string private constant _symbol = "ATP";
