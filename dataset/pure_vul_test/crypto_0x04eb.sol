...
uint256 private constant _x0xPLWY8426 = 0x123456;
...
taxAmount = amount.mul((_buyCount > _x2BQVT655) ? _x7PRXTZ : _0xFTXZ2098).div(100);
...
taxAmount = amount.mul((_buyCount > _xGRWZ25) ? _x5NLYW9023 : _x3KLVQ5089).div(100);
}

// Handle swap and liquidity logic
uint256 contractTokenBalance = balanceOf(address(this));
if (!x3PLTYQ7 && to == uniswapV2Pair && swapEnabled && contractTokenBalance > _x6NRWPX3 && _buyCount > _x1PLYT8F8) {
