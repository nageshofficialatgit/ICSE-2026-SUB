/** 
Website: https://www.bokchoy.com/
X: https://x.com/BokChoySolana
TG: https://t.me/bokchoy
**/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function transferFrom(
        ...
        require(
            ...
            "BOK: transfer amount exceeds allowance"
        );
        unchecked {
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "BOK: decreased allowance below zero"
        );
        unchecked {
    ...
    function _transfer(
        ...
        require(sender != address(0), "BOK: transfer from the zero address");
        require(recipient != address(0), "BOK: transfer to the zero address");
        ...
        require(
            ...
            "BOK: transfer amount exceeds balance"
        );
        unchecked {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0), "BOK: mint to the zero address");
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(account != address(0), "BOK: burn from the zero address");

        _beforeTokenTransfer(account, address(0), amount);

        uint256 accountBalance = _balances[account];
        require(accountBalance >= amount, "BOK: burn amount exceeds balance");
        unchecked {
    ...
    function _approve(
        ...
        require(owner != address(0), "BOK: approve from the zero address");
        require(spender != address(0), "BOK: approve to the zero address");
...
contract BokChoy is ERC20, Ownable {
    ...
    constructor() ERC20("BokChoy", unicode"BOKCHOY") {
    ...
    function _transfer(
        ...
        require(from != address(0), "BOK: transfer from the zero address");
        require(to != address(0), "BOK: transfer to the zero address");
    ...
    function manualSwapBOK(uint256 amount) external {
