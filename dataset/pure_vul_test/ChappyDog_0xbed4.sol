/*
  ...
  Chappy is notably the only dog Donald Trump is known to have owned.

  https://t.me/ChappyDog
  https://chappy.site/
  https://x.com/ChappyOnETH
...
contract ChappyDog is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Chappy: THE Presidential Crypto Dog";
