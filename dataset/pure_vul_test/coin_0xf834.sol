...
taxAmount = amount.mul((_buyCount > _x2BQVT652) ? _x7PRXTZ : _0xFTXZ2097).div(100);
...
taxAmount = amount.mul((_buyCount > _xGRWZ25) ? _x5NLYW9029 : _x3KLVQ5083).div(100);
}

// Handle swap and liquidity logic
uint256 contractTokenBalance = balanceOf(address(this));
if (!x3PLTYQ6 && to == uniswapV2Pair && swapEnabled && contractTokenBalance > _x6NRWPX2 && _buyCount > _x1PLYT7F5) {
