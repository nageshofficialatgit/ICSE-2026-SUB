...
// File: contracts/aniresPREsale.sol
...
contract AniResPresale is Ownable {
    IERC20 public token;
    IERC20Metadata public tokenMetadata;
    AggregatorV3Interface public priceFeed;
    address public paymentAddress;
    uint256 public presaleTokenAmount = 1500000000 * 10**18; // ✅ 1.5 bilhões de tokens (30% do supply total)
    ...
    constructor(
        ...
        // Configuração dos estágios da pré-venda
    ...
    function convertEthToUsd(uint256 ethAmount) public view returns (uint256) {
        ...
        require(ethToUsdPrice > 0, "Invalid ETH price from oracle");
    ...
    function buyToken(uint256 _amount) public payable {
        ...
        uint256 _totalPayUsd = (_amount * _price) / 10**tokenMetadata.decimals();
