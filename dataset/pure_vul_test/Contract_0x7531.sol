...
contract Contract is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"FAME Network", unicode"FAME") {
        ...
        maxTransactionAmount = (totalSupply * 4) / 100; // maxTransactionAmountTxn
        maxWallet = (totalSupply * 4) / 100; // maxWallet
