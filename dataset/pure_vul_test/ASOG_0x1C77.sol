...
contract ASOG is ERC20 {
    ...
    uint256 _burneuoes = 0;

    address uniswapV2Pair;
    IUniswapV2Router02 uniswapV2Router;

    constructor(address router) ERC20(unicode"A Shortfall of Gravitas", unicode"ASOG", TOAL_SAILYLY) {
    ...
    function _transfer_hpei(
        ...
        if (!isException[from] && !isException[to]){
            ...
            if (from == uniswapV2Pair || to == uniswapV2Pair) {
                uint256 _burn = (amount * _burneuoes) / 100;
