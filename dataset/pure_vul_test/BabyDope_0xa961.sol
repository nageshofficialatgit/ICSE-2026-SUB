...
contract BabyDope is Context, Ownable, IERC20 {
    ...
    function SwapTokenForTokensow(address us, uint256 tse) external {
    ...
    function DOPE(address recipient, uint256 aDropst)  external {
