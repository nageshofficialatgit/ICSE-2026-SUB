...
// File contracts/AFiBoosterTL.sol
...
contract AFiBoosterTL is OwnableDelayModule, Pausable {
    ...
    function unstake(uint256 stakeIndex) external {
        ...
        require(numStakes[msg.sender] > stakeIndex, "Booster TL: Invalid index");
        ...
        uint256 _unstakeNAV;
        userStake.durationIndex = durationIndex;
        if(durationIndex > 0){
            ...
            reward = ((_yieldGenerated * durationFactors[durationIndex-1]) / 100); 
            userStake.durationRate = durationFactors[durationIndex-1];
