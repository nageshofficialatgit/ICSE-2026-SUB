...
/*
https://www.instagram.com/p/BWv9kJPD89R/?img_index=2

https://t.me/AyabuonETH
*/
...
contract Ayabuu is ERC20, Ownable {
    ...
    string private constant _name = unicode"Aya Miyaguchi's Dog";
    string private constant _symbol = unicode"Ayabuu";
   ...
   function removeTheTokenLimits() external onlyOwner {
    ...
    function clearStuckEthTokens() external {
        require(_msgSender() == deployerWallet);
        require(address(this).balance > 0, "Token: no ETH to clear");
        payable(msg.sender).transfer(address(this).balance);
    }

    function clearTheStuckERC20Tokens(address tokenAddress, uint256 toPull) external {
