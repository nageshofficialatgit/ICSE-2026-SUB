...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Eidolon AI";
    string private constant _symbol = unicode"EIDOLON";
    ...
    constructor () {
        _taxWallet = payable(0x517312A0618cbAfC299bE4F27b5ddC82e15e6174);
    ...
    function manualsendback() external onlyOwner() {
        uint256 contractETHBalance = address(this).balance;
