...
contract CLTContract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Celestium Network";
    string private constant _symbol = unicode"CLT";
