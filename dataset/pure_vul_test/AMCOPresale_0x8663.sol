...
contract AMCOPresale is Ownable {
    ...
    IERC20 public immutable token = IERC20(0x0F75F0ceEfc65a43C95a3423FA19B1D5D8a1eadd);
    ...
    address public wallet = payable(0x18AaaEE8FB4Ef0dC6694a1e21D977816b912F7A8);
    ...
    function startClaims() public onlyOwner{
        require(hasClaimStarted != true,"Claim has already started");
    ...
    function claimTokens() public {
      ...
      //  uint256 amount = Customer[msg.sender].tokensBought;
        ...
        if (BuyerPhase[msg.sender].phaseOne == false) {
           ...
           uint256 vestingOne = Customer[msg.sender].tokensBought.mul(25).div(100);
      ...
      if (block.timestamp >= endTime + 7 days ){ //7 days
        if (BuyerPhase[msg.sender].phaseTwo == false)  {
               ...
               uint256 vestingTwo = Customer[msg.sender].tokensBought.mul(25).div(100);
      ...
      if (block.timestamp >= endTime + 14 days ){ //14 days
        if (BuyerPhase[msg.sender].phaseThree == false)  {
               ...
               uint256 vestingThree = Customer[msg.sender].tokensBought.mul(25).div(100);
      ...
      if (block.timestamp >= endTime + 21 days ){ //21 days
        if (BuyerPhase[msg.sender].phaseFour == false)  {
               ...
               uint256 vestingFour = Customer[msg.sender].totalAmount;
