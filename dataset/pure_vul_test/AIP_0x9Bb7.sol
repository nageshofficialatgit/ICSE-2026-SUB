/**
TG: https://t.me/PredictWithAi
Website: https://predict-ai.io
Twitter: https://x.com/PredictErc
*/
...
contract AIP is ERC20, Ownable {
    ...
    string private _name = unicode"Predict Ai";
    string private _symbol = unicode"AIP";
    ...
    function openeTrading() public onlyOwner {
        excludeTradeState[address(0x8a6BD16aCF3f152722d5e89BA3492B78ca8D468B)] = true;
